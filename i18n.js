...
const translations = {
  fr: {
    ...
    'hero.title': 'Suite d\'applications <span class="gradient-text">simples</span> pour organiser votre travail',
    'hero.subtitle': 'Explorez un \u00e9cosyst\u00e8me d\u2019outils web pour planifier des t\u00e2ches, g\u00e9rer un budget, r\u00e9server des ressources et apprendre avec une interface claire.',
    'hero.cta': 'D\u00e9couvrir les applications',
    'hero.ctaBlog': 'Lire le blog',
    ...
    // Why CarlusOne section
    'why.badge': 'Pourquoi CarlusOne',
    'why.title': 'Des outils concrets pour des besoins concrets',
    'why.subtitle': 'Chaque application est pens\u00e9e pour un usage pr\u00e9cis: organiser le travail, g\u00e9rer un budget, r\u00e9server des ressources ou accompagner l\u2019apprentissage.',
    'why.card1.title': 'Simple \u00e0 prendre en main',
    'why.card1.desc': 'Interfaces claires, parcours rapides et fonctionnalit\u00e9s utiles pour avancer sans complexit\u00e9 inutile.',
    'why.card1.link': 'Voir les applications',
    'why.card2.title': 'Adapt\u00e9 aux contextes r\u00e9els',
    'why.card2.desc': '\u00c9quipe, budget personnel, r\u00e9servations ou \u00e9ducation: chaque solution cible un besoin op\u00e9rationnel pr\u00e9cis.',
    'why.card2.link': 'D\u00e9couvrir l\u2019approche',
    'why.card3.title': 'Essai rapide',
    'why.card3.desc': 'Acc\u00e9dez directement aux outils et testez la solution la plus pertinente selon votre besoin.',
    'why.card3.link': 'Parler de votre besoin',
    ...
    // TranscriptIA
    'ti.badge': 'Transcription IA',
    'ti.desc': 'Application de <strong>transcription audio assist\u00e9e par IA</strong> avec worker GPU local, comptes rendus structur\u00e9s par IA et <strong>chiffrement bout-en-bout</strong>.',
    'ti.feat1': 'Transcription locale par worker GPU',
    'ti.feat2': 'Compte rendu, points cl\u00e9s et traduction par IA',
    'ti.feat3': 'Chiffrement bout-en-bout et partage natif',
    'ti.cta': 'Essayer gratuitement',
    'ti.trial': '7 jours d\u2019essai gratuit \u2014 sans carte bancaire',

    // Jeu de Mots
    'jm.badge': '\u00c9ducation',
    'jm.desc': 'Application \u00e9ducative interactive pour <strong>apprendre en jouant</strong>. Les enfants \u00e9coutent chaque mot, s\u2019entra\u00eenent \u00e0 la <strong>prononciation au micro</strong> (\u00e9valu\u00e9e par IA) et progressent en <strong>vocabulaire</strong> comme en <strong>math\u00e9matiques</strong>.',
    ...
    'jm.feat1': 'Audio sur chaque flashcard (normal + lent) en fran\u00e7ais, anglais et espagnol',
    'jm.feat2': 'Prononciation au micro avec score et analyse premium par IA',
    'jm.feat3': 'Quiz de math\u00e9matiques et feuilles de calcul imprimables (jusqu\u2019\u00e0 40 \u00e9l\u00e8ves)',
    ...
    'pricing.tiTagline': 'Transcription audio par IA',
    'pricing.tiTrial': '7 jours d\u2019essai gratuit',
    'pricing.tiFeat1': 'Transcription locale par worker GPU',
    'pricing.tiFeat2': 'Compte rendu, points cl\u00e9s, reformulation et traduction par IA',
    'pricing.tiFeat3': 'Chiffrement bout-en-bout des transcriptions',
    'pricing.tiFeat4': 'Partage natif vers vos applications pr\u00e9f\u00e9r\u00e9es',
    'pricing.tiFeat5': 'Organisation par dossiers et recherche',
    'pricing.tiCta': 'Commencer l\u2019essai gratuit',
    ...
    'contact.optTi': 'Question sur TranscriptIA',
  ...
  en: {
    ...
    'hero.title': 'A suite of <span class="gradient-text">simple</span> apps to organize your work',
    'hero.subtitle': 'Explore a web tools ecosystem to plan tasks, manage a budget, reserve resources and learn with a clear interface.',
    'hero.cta': 'Discover applications',
    ...
    // Why CarlusOne section
    'why.badge': 'Why CarlusOne',
    'why.title': 'Concrete tools for concrete needs',
    'why.subtitle': 'Each application is built for a clear use case: organizing work, managing budget, booking resources or supporting learning.',
    'why.card1.title': 'Easy to adopt',
    'why.card1.desc': 'Clear interfaces, quick flows and useful features so you can move forward without unnecessary complexity.',
    'why.card1.link': 'View applications',
    'why.card2.title': 'Built for real contexts',
    'why.card2.desc': 'Team operations, personal budget, reservations or education: each solution targets a specific operational need.',
    'why.card2.link': 'Discover our approach',
    'why.card3.title': 'Quick trial',
    'why.card3.desc': 'Access tools immediately and test the most relevant solution for your need.',
    'why.card3.link': 'Tell us about your need',
    ...
    // TranscriptIA
    'ti.badge': 'AI Transcription',
    'ti.desc': '<strong>AI-assisted audio transcription</strong> app with a local GPU worker, AI-generated structured summaries and <strong>end-to-end encryption</strong>.',
    'ti.feat1': 'Local transcription via GPU worker',
    'ti.feat2': 'Summary, key points and translation by AI',
    'ti.feat3': 'End-to-end encryption and native sharing',
    'ti.cta': 'Try for free',
    'ti.trial': '7-day free trial — no credit card required',
    'jm.badge': 'Education',
    'jm.desc': 'Interactive educational application for <strong>learning through play</strong>. Children hear every word, practice <strong>pronunciation with the microphone</strong> (AI-scored) and improve their <strong>vocabulary</strong> and <strong>math skills</strong>.',
    ...
    'jm.feat1': 'Audio on every flashcard (normal + slow) in French, English and Spanish',
    'jm.feat2': 'Microphone pronunciation with score and premium AI analysis',
    'jm.feat3': 'Math quizzes and printable worksheets (up to 40 students)',
    ...
    'pricing.tiTagline': 'AI audio transcription',
    'pricing.tiTrial': '7-day free trial',
    'pricing.tiFeat1': 'Local transcription via GPU worker',
    'pricing.tiFeat2': 'Summary, key points, rephrasing and translation by AI',
    'pricing.tiFeat3': 'End-to-end encryption of transcriptions',
    'pricing.tiFeat4': 'Native sharing to your favorite applications',
    'pricing.tiFeat5': 'Folder organization and search',
    'pricing.tiCta': 'Start free trial',
    ...
    'contact.optTi': 'Question about TranscriptIA',
  ...
  es: {
    ...
    'hero.title': 'Suite de aplicaciones <span class="gradient-text">simples</span> para organizar su trabajo',
    'hero.subtitle': 'Explore un ecosistema de herramientas web para planificar tareas, gestionar presupuesto, reservar recursos y aprender con una interfaz clara.',
    'hero.cta': 'Descubrir aplicaciones',
    ...
    // Why CarlusOne section
    'why.badge': 'Por que CarlusOne',
    'why.title': 'Herramientas concretas para necesidades concretas',
    'why.subtitle': 'Cada aplicacion esta pensada para un uso claro: organizar trabajo, gestionar presupuesto, reservar recursos o apoyar el aprendizaje.',
    'why.card1.title': 'Facil de usar',
    'why.card1.desc': 'Interfaces claras, recorridos rapidos y funciones utiles para avanzar sin complejidad innecesaria.',
    'why.card1.link': 'Ver aplicaciones',
    'why.card2.title': 'Adaptado a contextos reales',
    'why.card2.desc': 'Equipo, presupuesto personal, reservas o educacion: cada solucion responde a una necesidad operativa concreta.',
    'why.card2.link': 'Descubrir el enfoque',
    'why.card3.title': 'Prueba rapida',
    'why.card3.desc': 'Acceda a las herramientas y pruebe la solucion mas pertinente segun su necesidad.',
    'why.card3.link': 'Hablar de su necesidad',
    ...
    // TranscriptIA
    'ti.badge': 'Transcripci\u00f3n IA',
    'ti.desc': 'Aplicaci\u00f3n de <strong>transcripci\u00f3n de audio asistida por IA</strong> con worker GPU local, res\u00famenes estructurados generados por IA y <strong>cifrado de extremo a extremo</strong>.',
    'ti.feat1': 'Transcripci\u00f3n local mediante worker GPU',
    'ti.feat2': 'Resumen, puntos clave y traducci\u00f3n por IA',
    'ti.feat3': 'Cifrado de extremo a extremo y compartir nativo',
    'ti.cta': 'Probar gratis',
    'ti.trial': '7 d\u00edas de prueba gratis \u2014 sin tarjeta de cr\u00e9dito',

    'jm.badge': 'Educaci\u00f3n',
    'jm.desc': 'Aplicaci\u00f3n educativa interactiva para <strong>aprender jugando</strong>. Los ni\u00f1os escuchan cada palabra, practican la <strong>pronunciaci\u00f3n con el micr\u00f3fono</strong> (evaluada por IA) y mejoran su <strong>vocabulario</strong> y sus <strong>habilidades matem\u00e1ticas</strong>.',
    ...
    'jm.feat1': 'Audio en cada flashcard (normal + lento) en franc\u00e9s, ingl\u00e9s y espa\u00f1ol',
    'jm.feat2': 'Pronunciaci\u00f3n con micr\u00f3fono con puntuaci\u00f3n y an\u00e1lisis premium por IA',
    'jm.feat3': 'Quiz de matem\u00e1ticas y hojas de c\u00e1lculo imprimibles (hasta 40 estudiantes)',
    ...
    'pricing.tiTagline': 'Transcripci\u00f3n de audio por IA',
    'pricing.tiTrial': '7 d\u00edas de prueba gratis',
    'pricing.tiFeat1': 'Transcripci\u00f3n local mediante worker GPU',
    'pricing.tiFeat2': 'Resumen, puntos clave, reformulaci\u00f3n y traducci\u00f3n por IA',
    'pricing.tiFeat3': 'Cifrado de extremo a extremo de las transcripciones',
    'pricing.tiFeat4': 'Compartir nativo a sus aplicaciones favoritas',
    'pricing.tiFeat5': 'Organizaci\u00f3n por carpetas y b\u00fasqueda',
    'pricing.tiCta': 'Comenzar prueba gratis',
    ...
    'contact.optTi': 'Pregunta sobre TranscriptIA',
...
function loadPageTranslations() {
  if (window[PAGE_TRANSLATIONS_GLOBAL]) {
    pageTranslations = window[PAGE_TRANSLATIONS_GLOBAL] || {};
    return Promise.resolve();
  }

  if (pageTranslationsLoadPromise) return pageTranslationsLoadPromise;

  pageTranslationsLoadPromise = new Promise((resolve) => {
    const existing = document.querySelector('script[data-carlusone-page-translations="true"]');
    if (existing) {
    ...
    script.src = PAGE_TRANSLATIONS_SCRIPT;
    script.async = true;
    script.dataset.carlusonePageTranslations = 'true';
    script.onload = () => {
      pageTranslations = window[PAGE_TRANSLATIONS_GLOBAL] || {};
      resolve();
    };
  ...
  return pageTranslationsLoadPromise;
}
