...
npx --yes esbuild pricing.js --minify --outfile=pricing.min.js | Out-Null

Write-Host "Done. Sizes:" -ForegroundColor Green
Get-ChildItem styles.min.css, script.min.js, i18n.min.js, i18n.lazy-loader.min.js, i18n.pageTranslations.min.js, pricing.min.js |
