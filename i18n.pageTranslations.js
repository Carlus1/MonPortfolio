...
window.__CARLUSONE_PAGE_TRANSLATIONS = {
  '/applications/': {
    en: {
      ...
      text: [
        ...
        { selector: '.app-link-card:nth-child(4) .card-kicker', value: 'AI transcription' },
        { selector: '.app-link-card:nth-child(4) p', value: 'AI-assisted audio transcription app with a local GPU worker, structured meeting notes, end-to-end encryption and one-click sharing.' },
        ...
        { selector: '.app-link-card:nth-child(5) .card-kicker', value: 'Education' },
        { selector: '.app-link-card:nth-child(5) p', value: 'Educational app with audio flashcards, AI-scored mic pronunciation, math quizzes, printable worksheets with answer key and Live Classroom Mode (code + QR) to run interactive exercises in real time.' },
        { selector: '.app-link-card:nth-child(5) .button-row a:nth-child(1)', value: 'View page' },
        { selector: '.app-link-card:nth-child(5) .button-row a:nth-child(2)', value: 'Open app' },
    ...
    es: {
      ...
      text: [
        ...
        { selector: '.app-link-card:nth-child(4) .card-kicker', value: 'Transcripcion IA' },
        { selector: '.app-link-card:nth-child(4) p', value: 'Aplicacion de transcripcion de audio asistida por IA con worker GPU local, actas estructuradas, cifrado de extremo a extremo y compartir con un clic.' },
        ...
        { selector: '.app-link-card:nth-child(5) .card-kicker', value: 'Educacion' },
        { selector: '.app-link-card:nth-child(5) p', value: 'Aplicacion educativa con flashcards audio, pronunciacion con microfono evaluada por IA, cuestionarios de matematicas, hojas imprimibles con clave y Modo Clase en Vivo (codigo + QR) para lanzar ejercicios interactivos en directo.' },
        { selector: '.app-link-card:nth-child(5) .button-row a:nth-child(1)', value: 'Ver pagina' },
        { selector: '.app-link-card:nth-child(5) .button-row a:nth-child(2)', value: 'Abrir app' },
  ...
  '/applications/gestbudget/': {
    en: {
      ...
      text: [
        ...
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-question span', value: 'How do I install GestBudget as an app on my phone?' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-answer', value: 'Open GestBudget in your mobile browser, then use Add to Home Screen. On Android: browser menu then Install app or Add to Home screen. On iPhone: Share button then On home screen.' },
    ...
    es: {
      ...
      text: [
        ...
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-question span', value: 'Como instalo GestBudget como aplicacion en mi movil?' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-answer', value: 'Abre GestBudget en tu navegador movil y usa Anadir a la pantalla de inicio. En Android: menu del navegador y Instalar aplicacion o Anadir a pantalla de inicio. En iPhone: boton Compartir y En la pantalla de inicio.' },
  ...
  '/applications/gestreserve/': {
    en: {
      ...
      text: [
        ...
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-question span', value: 'How do I install GestReserve as an app on my phone?' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-answer', value: 'Open GestReserve in your mobile browser, then use Add to Home Screen. On Android: browser menu then Install app or Add to Home screen. On iPhone: Share button then On home screen.' },
    ...
    es: {
      ...
      text: [
        ...
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-question span', value: 'Como instalo GestReserve como aplicacion en mi movil?' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-answer', value: 'Abre GestReserve en tu navegador movil y usa Anadir a la pantalla de inicio. En Android: menu del navegador y Instalar aplicacion o Anadir a pantalla de inicio. En iPhone: boton Compartir y En la pantalla de inicio.' },
  ...
  '/applications/transcriptia/': {
    en: {
      ...
      text: [
        ...
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-question span', value: 'How do I install TranscriptIA as an app on my phone?' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-answer', value: 'Open TranscriptIA in your mobile browser, then use Add to Home Screen. On Android: browser menu then Install app or Add to Home screen. On iPhone: Share button then On home screen.' },
    ...
    es: {
      ...
      text: [
        ...
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-question span', value: 'Como instalo TranscriptIA como aplicacion en mi movil?' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-answer', value: 'Abre TranscriptIA en tu navegador movil y usa Anadir a la pantalla de inicio. En Android: menu del navegador y Instalar aplicacion o Anadir a pantalla de inicio. En iPhone: boton Compartir y En la pantalla de inicio.' },
  ...
  '/applications/jeudemots/': {
    en: {
      title: 'Jeu de Mots | Educational app with audio and mic pronunciation',
      description: 'Help children progress with audio flashcards, AI-scored mic pronunciation, math quizzes, printable worksheets with answer key and Live Classroom sessions (code + QR). Free trial available.',
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: 'Jeu de Mots' },
        { selector: '.page-hero .page-kicker', value: 'Education' },
        { selector: '.page-hero .page-title', value: 'Educational app with audio and mic pronunciation' },
        { selector: '.page-hero .page-subtitle', value: 'Jeu de Mots helps children, parents and teachers learn French, English and Spanish with audio flashcards, microphone pronunciation scoring (premium AI analysis), math quizzes and printable worksheets.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) h2', value: 'Description' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'Jeu de Mots is designed to make learning smoother and more playful. Children create or import word lists, review with audio flashcards (normal or slow speech), practice pronunciation with the microphone and get instant feedback, and round out the experience with math activities.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'The service suits both home use and the classroom, in French, English or Spanish.' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) h2', value: 'Features' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(1)', value: '🔊 Audio on every flashcard (normal + slow)' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(2)', value: '🎤 Scored mic pronunciation (premium AI)' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(3)', value: 'French, English and Spanish flashcards' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: '10 ready-to-use themes (Animals, Food…)' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Math quizzes (+, −, ×, ÷)' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(6)', value: 'Printable worksheets, up to 40 students' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(7)', value: '📝 Printable answer key included' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(8)', value: '🎓 Live Classroom Mode with code + QR' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(9)', value: '📊 Session history + CSV export' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(10)', value: 'Student management + cloud sync' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Pricing' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ month' },
        { selector: '.content-grid.three-col .content-card#tarif .pricing-trial span', value: '2-day free trial' },
        { selector: '.content-grid.three-col .content-card#tarif a.btn', value: 'Get started' },
        ...
        { selector: '#prononciation .section-header .section-badge', value: 'New' },
        { selector: '#prononciation .section-header .section-title', value: 'Audio and mic pronunciation' },
        { selector: '#prononciation .section-header .section-subtitle', value: 'Two complementary tools to learn how to hear and speak a foreign language, right inside the French, English and Spanish flashcards.' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(1) h3', value: '🔊 Listen to the word' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'Every flashcard on the language sheets shows two audio buttons:' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(1) li:nth-child(1)', value: 'Listen — normal-speed pronunciation' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(1) li:nth-child(2)', value: 'Listen slowly — syllable by syllable to catch every sound' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'Audio is generated by the browser\u2019s speech synthesis, in the language of the card. No download, no third-party account.' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) h3', value: '🎤 Speak and get scored' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) p:nth-of-type(1)', value: 'The child clicks the mic button, pronounces the word and receives instant feedback:' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) li:nth-child(1)', value: 'Percentage score (0–100)' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) li:nth-child(2)', value: 'Encouragement message: Excellent!, Good, Almost, Try again' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) li:nth-child(3)', value: 'Heard word displayed for visual comparison' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) li:nth-child(4)', value: 'Premium AI analysis for subscribers (more accurate score)' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) p:nth-of-type(2)', value: 'Ideal for autonomous language learning: the child can practice alone, even when a parent doesn\u2019t speak the target language.' },
        { selector: '#prononciation > div > .content-card h3', value: 'Why it matters' },
        { selector: '#prononciation > div > .content-card li:nth-child(1)', value: 'Sensory learning — pairing the written word, the sound and the vocal production reinforces memorization.' },
        { selector: '#prononciation > div > .content-card li:nth-child(2)', value: 'Autonomy — the child can practice alone, even when a parent doesn\u2019t speak the target language.' },
        { selector: '#prononciation > div > .content-card li:nth-child(3)', value: 'Objective feedback — the score removes subjectivity and motivates progress.' },
        { selector: '#prononciation > div > .content-card li:nth-child(4)', value: 'Three languages — audio and mic work in French, English and Spanish.' },
        { selector: '#mode-classe-live .section-header .section-badge', value: 'New' },
        { selector: '#mode-classe-live .section-header .section-title', value: 'Live Classroom Mode with code + QR' },
        { selector: '#mode-classe-live .section-header .section-subtitle', value: 'Turn any calculation sheet into a real-time interactive exercise: students join from their own device with a simple 4-digit code or a QR code, and you see their results live.' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) h3', value: '🎓 Teacher side' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) li:nth-child(1)', value: '4-digit session code generated at every launch' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) li:nth-child(2)', value: 'Large QR code shown on the board' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Waiting room: students join, you start when everyone is ready' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Synchronised timer for the whole class at once' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) li:nth-child(5)', value: 'Real-time table of participants and scores' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) h3', value: '🙋 Student side' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) li:nth-child(1)', value: 'No account required — just a first name' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) li:nth-child(2)', value: 'Join by scanning the QR code with the camera' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) li:nth-child(3)', value: 'Or enter the code from the public /rejoindre page' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) li:nth-child(4)', value: 'Interactive sheet with a visible timer' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) li:nth-child(5)', value: 'Instant answer key with colour-coded results' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) h3', value: '📊 History and follow-up' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) > p', value: 'Every session is saved in My sessions for the teacher:' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) li:nth-child(1)', value: 'Real-time list of all your past sessions (code, date, duration, status, number of students)' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) li:nth-child(2)', value: 'Per-session detail with the final score of each student' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) li:nth-child(3)', value: 'UTF-8 CSV export compatible with Excel and Google Sheets to enter grades in your gradebook' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) li:nth-child(4)', value: 'Individual deletion with confirmation' },
        { selector: '#mode-classe-live > .container > div:nth-child(4) h3', value: 'Why it matters in class' },
        { selector: '#mode-classe-live > .container > div:nth-child(4) li:nth-child(1)', value: 'Zero friction for students — a QR code, a first name, done' },
        { selector: '#mode-classe-live > .container > div:nth-child(4) li:nth-child(2)', value: 'No photocopies — less prep, less paper' },
        { selector: '#mode-classe-live > .container > div:nth-child(4) li:nth-child(3)', value: 'Instant feedback — each student sees their mistakes the second they finish' },
        { selector: '#mode-classe-live > .container > div:nth-child(4) li:nth-child(4)', value: 'Consolidated results — no manual grading, everything is calculated' },
        ...
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-question span', value: 'How does the flashcard audio pronunciation work?' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-answer', value: 'Each language card provides two audio buttons: normal listen and slow listen. The browser speech synthesis pronounces the word in the correct language — French, English or Spanish.' },
        { selector: '.faq-grid .faq-item:nth-child(5) .faq-question span', value: 'How is a child evaluated when they pronounce a word into the microphone?' },
        { selector: '.faq-grid .faq-item:nth-child(5) .faq-answer', value: 'The child clicks the mic button and pronounces the word. The heard word and a percentage score are displayed with an encouragement message (Excellent, Good, Almost, Try again). Subscribers get a premium AI analysis for a more accurate score.' },
        { selector: '.faq-grid .faq-item:nth-child(6) .faq-question span', value: 'How does the Live Classroom Mode work with code and QR?' },
        { selector: '.faq-grid .faq-item:nth-child(6) .faq-answer', value: 'The teacher starts a session from the calculation sheet and gets a 4-digit code and a large QR code. Students scan the QR (or type the code on the public /rejoindre page) and join with just their first name. A waiting room lets everyone start the timer at the same time. Each student sees an instant answer key at the end.' },
        { selector: '.faq-grid .faq-item:nth-child(7) .faq-question span', value: 'How do I retrieve past live session results?' },
        { selector: '.faq-grid .faq-item:nth-child(7) .faq-answer', value: 'A "My sessions" page in the user menu lists all the sessions you have created (code, date, duration, status, number of students). Session details show every student\u2019s score and let you export a UTF-8 CSV file, compatible with Excel and Google Sheets.' },
        { selector: '.faq-grid .faq-item:nth-child(8) .faq-question span', value: 'How do I install Jeu de Mots as an app on my phone?' },
        { selector: '.faq-grid .faq-item:nth-child(8) .faq-answer', value: 'Open Jeu de Mots in your mobile browser, then use Add to Home Screen. On Android: browser menu then Install app or Add to Home screen. On iPhone: Share button then On home screen.' },
    ...
    es: {
      title: 'Jeu de Mots | Aplicacion educativa con pronunciacion audio y microfono',
      description: 'Ayude a los ninos a progresar con flashcards audio, pronunciacion con microfono evaluada por IA, quizzes de matematicas, hojas imprimibles con clave y sesiones Modo Clase en Vivo (codigo + QR). Prueba gratuita.',
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: 'Jeu de Mots' },
        { selector: '.page-hero .page-kicker', value: 'Educacion' },
        { selector: '.page-hero .page-title', value: 'Aplicacion educativa con pronunciacion audio y microfono' },
        { selector: '.page-hero .page-subtitle', value: 'Jeu de Mots ayuda a ninos, padres y docentes a aprender frances, ingles y espanol con flashcards audio, evaluacion de la pronunciacion con microfono (analisis premium por IA), quizzes de matematicas y hojas imprimibles.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) h2', value: 'Descripcion' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'Jeu de Mots esta disenado para hacer el aprendizaje mas fluido y divertido. Los ninos crean o importan listas de palabras, repasan con flashcards audio (voz normal o lenta), practican la pronunciacion con el microfono y reciben feedback inmediato, y completan la experiencia con actividades matematicas.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'El servicio conviene tanto en casa como en el aula, en frances, ingles o espanol.' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) h2', value: 'Funciones' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(1)', value: '🔊 Audio en cada flashcard (normal + lento)' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(2)', value: '🎤 Pronunciacion con micro evaluada (IA premium)' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(3)', value: 'Flashcards frances, ingles y espanol' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: '10 temas listos para usar (Animales, Comida...)' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Quizzes de matematicas (+, −, ×, ÷)' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(6)', value: 'Hojas imprimibles, hasta 40 estudiantes' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(7)', value: '📝 Clave de respuestas imprimible incluida' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(8)', value: '🎓 Modo Clase en Vivo con codigo + QR' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(9)', value: '📊 Historial de sesiones + exportacion CSV' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(10)', value: 'Gestion de estudiantes + nube' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Precios' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ mes' },
        { selector: '.content-grid.three-col .content-card#tarif .pricing-trial span', value: '2 dias de prueba gratis' },
        { selector: '.content-grid.three-col .content-card#tarif a.btn', value: 'Comenzar' },
        ...
        { selector: '#prononciation .section-header .section-badge', value: 'Novedad' },
        { selector: '#prononciation .section-header .section-title', value: 'Pronunciacion audio y microfono' },
        { selector: '#prononciation .section-header .section-subtitle', value: 'Dos herramientas complementarias para aprender a escuchar y a hablar un idioma, dentro de las flashcards de frances, ingles y espanol.' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(1) h3', value: '🔊 Escuchar la palabra' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'Cada flashcard de las hojas de idiomas muestra dos botones de audio:' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(1) li:nth-child(1)', value: 'Escuchar — pronunciacion a velocidad normal' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(1) li:nth-child(2)', value: 'Escuchar despacio — silaba por silaba para captar cada sonido' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'El audio se genera con la sintesis de voz del navegador, en el idioma de la carta. Sin descargas ni cuentas de terceros.' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) h3', value: '🎤 Hablar y ser evaluado' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) p:nth-of-type(1)', value: 'El nino pulsa el boton de microfono, pronuncia la palabra y recibe feedback inmediato:' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) li:nth-child(1)', value: 'Puntuacion en porcentaje (0–100)' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) li:nth-child(2)', value: 'Mensaje de animo: Excelente!, Bien, Casi, Intentalo de nuevo' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) li:nth-child(3)', value: 'Palabra escuchada mostrada para comparar visualmente' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) li:nth-child(4)', value: 'Analisis premium por IA para suscriptores (puntuacion mas precisa)' },
        { selector: '#prononciation .content-grid.two-col .content-card:nth-child(2) p:nth-of-type(2)', value: 'Ideal para el aprendizaje autonomo de un idioma: el nino practica solo, incluso cuando un padre no habla la lengua objetivo.' },
        { selector: '#prononciation > div > .content-card h3', value: 'Por que es util' },
        { selector: '#prononciation > div > .content-card li:nth-child(1)', value: 'Aprendizaje sensorial — asociar la palabra escrita, el sonido y la produccion vocal refuerza la memorizacion.' },
        { selector: '#prononciation > div > .content-card li:nth-child(2)', value: 'Autonomia — el nino puede repasar solo, incluso cuando un padre no habla el idioma objetivo.' },
        { selector: '#prononciation > div > .content-card li:nth-child(3)', value: 'Feedback objetivo — la puntuacion quita subjetividad y motiva a progresar.' },
        { selector: '#prononciation > div > .content-card li:nth-child(4)', value: 'Tres idiomas — audio y micro funcionan en frances, ingles y espanol.' },
        { selector: '#mode-classe-live .section-header .section-badge', value: 'Novedad' },
        { selector: '#mode-classe-live .section-header .section-title', value: 'Modo Clase en Vivo con codigo + QR' },
        { selector: '#mode-classe-live .section-header .section-subtitle', value: 'Convierta cualquier hoja de calculo en un ejercicio interactivo en tiempo real: los estudiantes se unen desde su propio dispositivo con un codigo de 4 digitos o un codigo QR, y usted ve los resultados en vivo.' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) h3', value: '🎓 Lado docente' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) li:nth-child(1)', value: 'Codigo de sesion de 4 digitos generado en cada lanzamiento' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) li:nth-child(2)', value: 'Codigo QR grande mostrado en la pizarra' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Sala de espera: los estudiantes se unen, usted inicia cuando todos estan listos' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Cronometro sincronizado para toda la clase a la vez' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(1) li:nth-child(5)', value: 'Tabla en tiempo real de participantes y puntuaciones' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) h3', value: '🙋 Lado estudiante' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) li:nth-child(1)', value: 'Sin cuenta necesaria — solo un nombre' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) li:nth-child(2)', value: 'Union escaneando el codigo QR con la camara' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) li:nth-child(3)', value: 'O ingresando el codigo desde la pagina publica /rejoindre' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) li:nth-child(4)', value: 'Hoja interactiva con cronometro visible' },
        { selector: '#mode-classe-live .content-grid.two-col .content-card:nth-child(2) li:nth-child(5)', value: 'Clave inmediata con resultados por color' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) h3', value: '📊 Historial y seguimiento' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) > p', value: 'Cada sesion se conserva en Mis sesiones para el docente:' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) li:nth-child(1)', value: 'Lista en tiempo real de todas sus sesiones pasadas (codigo, fecha, duracion, estado, numero de estudiantes)' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) li:nth-child(2)', value: 'Detalle por sesion con la puntuacion final de cada estudiante' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) li:nth-child(3)', value: 'Exportacion CSV UTF-8 compatible con Excel y Google Sheets para llevar las notas al cuaderno' },
        { selector: '#mode-classe-live > .container > div:nth-child(3) li:nth-child(4)', value: 'Eliminacion individual con confirmacion' },
        { selector: '#mode-classe-live > .container > div:nth-child(4) h3', value: 'Por que cambia todo en clase' },
        { selector: '#mode-classe-live > .container > div:nth-child(4) li:nth-child(1)', value: 'Cero friccion para los estudiantes — un QR, un nombre, listo' },
        { selector: '#mode-classe-live > .container > div:nth-child(4) li:nth-child(2)', value: 'Sin fotocopias — menos preparacion, menos papel' },
        { selector: '#mode-classe-live > .container > div:nth-child(4) li:nth-child(3)', value: 'Retroalimentacion inmediata — cada estudiante ve sus errores en cuanto termina' },
        { selector: '#mode-classe-live > .container > div:nth-child(4) li:nth-child(4)', value: 'Resultados consolidados — sin correccion manual, todo se calcula' },
        ...
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-question span', value: 'Como funciona la pronunciacion audio de las flashcards?' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-answer', value: 'Cada carta de idioma ofrece dos botones de audio: escucha normal y escucha lenta. La sintesis de voz del navegador pronuncia la palabra en el idioma correcto: frances, ingles o espanol.' },
        { selector: '.faq-grid .faq-item:nth-child(5) .faq-question span', value: 'Como se evalua a un nino cuando pronuncia una palabra en el microfono?' },
        { selector: '.faq-grid .faq-item:nth-child(5) .faq-answer', value: 'El nino pulsa el boton de microfono y pronuncia la palabra. La palabra escuchada y una puntuacion en porcentaje se muestran junto a un mensaje de animo (Excelente, Bien, Casi, Intentalo de nuevo). Los suscriptores reciben un analisis premium por IA con una puntuacion mas precisa.' },
        { selector: '.faq-grid .faq-item:nth-child(6) .faq-question span', value: 'Como funciona el Modo Clase en Vivo con codigo y QR?' },
        { selector: '.faq-grid .faq-item:nth-child(6) .faq-answer', value: 'El docente inicia una sesion desde la hoja de calculo y obtiene un codigo de 4 digitos y un codigo QR grande. Los estudiantes escanean el QR (o escriben el codigo en la pagina publica /rejoindre) y se unen solo con su nombre. Una sala de espera permite iniciar el cronometro para todos al mismo tiempo. Cada estudiante ve una clave inmediata al final.' },
        { selector: '.faq-grid .faq-item:nth-child(7) .faq-question span', value: 'Como recuperar los resultados de las sesiones en vivo pasadas?' },
        { selector: '.faq-grid .faq-item:nth-child(7) .faq-answer', value: 'La pagina "Mis sesiones" del menu de usuario lista todas las sesiones creadas (codigo, fecha, duracion, estado, numero de estudiantes). El detalle muestra la puntuacion de cada estudiante y permite exportar los resultados a CSV UTF-8, compatible con Excel y Google Sheets.' },
        { selector: '.faq-grid .faq-item:nth-child(8) .faq-question span', value: 'Como instalo Jeu de Mots como aplicacion en mi movil?' },
        { selector: '.faq-grid .faq-item:nth-child(8) .faq-answer', value: 'Abre Jeu de Mots en tu navegador movil y usa Anadir a la pantalla de inicio. En Android: menu del navegador y Instalar aplicacion o Anadir a pantalla de inicio. En iPhone: boton Compartir y En la pantalla de inicio.' },
  ...
  '/blog/quiz-calcul-mental-live-classe-qr-code/': {
    en: {
      title: "Live classroom mental math quiz with QR code: a simple method",
      description: "Run a live mental math quiz in your class: one code, one QR code, no login for students, real-time results and instant answer key.",
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: "Live mental math quiz with QR code" },
        { selector: '.page-hero .page-kicker', value: "Education" },
        { selector: '.page-hero .page-title', value: "Live classroom mental math quiz with QR code" },
        { selector: '.page-hero .page-subtitle', value: "A code, a QR code, no login for students, live results and an instant answer key." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. All rights reserved.' }
      ]
    },
    es: {
      title: "Quiz de calculo mental en vivo con codigo QR: un metodo simple",
      description: "Lance un quiz de calculo mental en vivo en su clase: un codigo, un QR, sin inicio de sesion para los estudiantes, resultados en tiempo real y clave inmediata.",
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: "Quiz de calculo mental en vivo con QR" },
        { selector: '.page-hero .page-kicker', value: "Educacion" },
        { selector: '.page-hero .page-title', value: "Quiz de calculo mental en vivo en clase con codigo QR" },
        { selector: '.page-hero .page-subtitle', value: "Un codigo, un QR, sin inicio de sesion para los estudiantes, resultados en vivo y clave inmediata." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. Todos los derechos reservados.' }
      ]
    }
  },
  '/blog/suivre-progres-eleves-sessions-live/': {
    en: {
      title: "Track student progress with live session history and CSV export",
      description: "Keep a clear view of every student\u2019s progress: session history, per-student detail and CSV export ready for your gradebook.",
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: "Track progress with live session history" },
        { selector: '.page-hero .page-kicker', value: "Education" },
        { selector: '.page-hero .page-title', value: "Track student progress with live session history" },
        { selector: '.page-hero .page-subtitle', value: "Session history, per-student detail and CSV export straight to your gradebook." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. All rights reserved.' }
      ]
    },
    es: {
      title: "Seguir el progreso de los estudiantes con el historial de sesiones y exportacion CSV",
      description: "Tenga una vista clara del progreso de cada estudiante: historial de sesiones, detalle por estudiante y exportacion CSV lista para su cuaderno.",
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: "Seguir el progreso con el historial de sesiones" },
        { selector: '.page-hero .page-kicker', value: "Educacion" },
        { selector: '.page-hero .page-title', value: "Seguir el progreso de los estudiantes con las sesiones en vivo" },
        { selector: '.page-hero .page-subtitle', value: "Historial de sesiones, detalle por estudiante y exportacion CSV directa al cuaderno." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. Todos los derechos reservados.' }
      ]
    }
  },
  ...
  '/blog/apprendre-langue-audio-enfant/': {
    en: {
      title: "Learning a language with audio | Method for children",
      description: "How to use flashcard audio (normal and slow playback) to help a child improve in English or Spanish without stress.",
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: "Audio and language learning" },
        { selector: '.page-hero .page-kicker', value: "Education" },
        { selector: '.page-hero .page-title', value: "Learning a language with audio (children)" },
        { selector: '.page-hero .page-subtitle', value: "Listen often, repeat, feel the rhythm: how flashcard audio accelerates foreign language learning." },
        { selector: '.content-prose > p:nth-of-type(1)', value: "In young children, the ear develops before reading. Regularly hearing a word in the target language helps memorise pronunciation, rhythm and specific sounds." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "Why audio makes a difference" },
        { selector: '.content-prose ul > li:nth-child(1)', value: "The child hears the correct pronunciation, not an approximate French reading." },
        { selector: '.content-prose ul > li:nth-child(2)', value: "Slow listening isolates each syllable." },
        { selector: '.content-prose ul > li:nth-child(3)', value: "Audio frees a parent who doesn\u2019t master the language." },
        { selector: '.content-prose ul > li:nth-child(4)', value: "Auditory repetition adds to visual memorisation." },
        { selector: '.content-prose h2:nth-of-type(2)', value: "How to structure a session" },
        { selector: '.content-prose ol > li:nth-child(1)', value: "Pick 10 to 15 words in the same category (food, animals, school\u2026)." },
        { selector: '.content-prose ol > li:nth-child(2)', value: "Listen to each word once at normal speed." },
        { selector: '.content-prose ol > li:nth-child(3)', value: "Replay in slow mode; the child repeats after the audio." },
        { selector: '.content-prose ol > li:nth-child(4)', value: "Go back to normal speed at the end of the session to check comprehension." },
        { selector: '.content-prose ol > li:nth-child(5)', value: "Restart a short session the next day with the same words." },
        { selector: '.content-prose > p:nth-of-type(2)', value: "This method turns a simple reading exercise into a real daily sound bath, without overloading child or parent." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) h3', value: "Related app" },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) p', value: "Jeu de Mots offers normal and slow listening on every language flashcard." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) .button-row a', value: "See Jeu de Mots" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) h3', value: "Read next" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(1)', value: "Mic pronunciation scored by AI" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(2)', value: "Flashcards for children: simple method" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(3)', value: "Improve a child\u2019s vocabulary" },
        { selector: '.section-header .section-title', value: "Frequently asked questions" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "At what age should audio in a foreign language start?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "As early as kindergarten. A child\u2019s ear is especially receptive before age 7, even without understanding every word." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "Should slow audio be used from the start?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "Yes for complex or unfamiliar words. Normal mode is enough for short, common words." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Which tool offers this audio mode on flashcards?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "Jeu de Mots offers two audio buttons (normal and slow) on every French, English and Spanish flashcard." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. All rights reserved.' }
      ],
      html: [
        { selector: '.content-prose > p:nth-of-type(3)', value: '<a href="/applications/jeudemots/">Jeu de Mots</a> integrates this audio mode directly into the French, English and Spanish flashcards.' }
      ]
    },
    es: {
      title: "Aprender un idioma con audio | Metodo para ninos",
      description: "Como usar el audio (reproduccion normal y lenta) de las flashcards para ayudar al nino a progresar en ingles o espanol sin estres.",
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: "Audio y aprendizaje de idiomas" },
        { selector: '.page-hero .page-kicker', value: "Educacion" },
        { selector: '.page-hero .page-title', value: "Aprender un idioma con audio (ninos)" },
        { selector: '.page-hero .page-subtitle', value: "Escuchar a menudo, repetir, sentir el ritmo: como el audio de las flashcards acelera el aprendizaje de un idioma extranjero." },
        { selector: '.content-prose > p:nth-of-type(1)', value: "En el nino, el oido se forma antes que la lectura. Escuchar con regularidad una palabra en el idioma objetivo ayuda a memorizar su pronunciacion, su ritmo y sus sonidos especificos." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "Por que el audio marca la diferencia" },
        { selector: '.content-prose ul > li:nth-child(1)', value: "El nino escucha la pronunciacion correcta, no una lectura aproximada en frances." },
        { selector: '.content-prose ul > li:nth-child(2)', value: "La escucha lenta permite aislar cada silaba." },
        { selector: '.content-prose ul > li:nth-child(3)', value: "El audio libera al padre que no domina el idioma." },
        { selector: '.content-prose ul > li:nth-child(4)', value: "La repeticion auditiva se suma a la memorizacion visual." },
        { selector: '.content-prose h2:nth-of-type(2)', value: "Como estructurar una sesion" },
        { selector: '.content-prose ol > li:nth-child(1)', value: "Elige de 10 a 15 palabras de una misma categoria (comida, animales, escuela\u2026)." },
        { selector: '.content-prose ol > li:nth-child(2)', value: "Escucha cada palabra una vez a velocidad normal." },
        { selector: '.content-prose ol > li:nth-child(3)', value: "Vuelve a escuchar en modo lento; el nino repite despues del audio." },
        { selector: '.content-prose ol > li:nth-child(4)', value: "Regresa al modo normal al final de la sesion para verificar la comprension." },
        { selector: '.content-prose ol > li:nth-child(5)', value: "Retoma una sesion corta al dia siguiente con las mismas palabras." },
        { selector: '.content-prose > p:nth-of-type(2)', value: "Este metodo convierte un simple ejercicio de lectura en un verdadero bano sonoro diario, sin sobrecargar al nino ni al padre." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) h3', value: "Aplicacion relacionada" },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) p', value: "Jeu de Mots ofrece escucha normal y lenta en cada flashcard de idioma." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) .button-row a', value: "Ver Jeu de Mots" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) h3', value: "Leer a continuacion" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(1)', value: "Pronunciacion con micro evaluada por IA" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(2)', value: "Flashcards para ninos: metodo simple" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(3)', value: "Mejorar el vocabulario de un nino" },
        { selector: '.section-header .section-title', value: "Preguntas frecuentes" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "A que edad empezar el audio en un idioma extranjero?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "Desde el preescolar. El oido del nino es especialmente receptivo antes de los 7 anos, aunque no entienda el sentido de cada palabra." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "Hay que usar el audio lento desde el principio?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "Si para palabras complejas o poco familiares. El modo normal basta para palabras cortas y comunes." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Que herramienta ofrece este modo audio en las flashcards?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "Jeu de Mots ofrece dos botones de audio (normal y lento) en cada flashcard de frances, ingles y espanol." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. Todos los derechos reservados.' }
      ],
      html: [
        { selector: '.content-prose > p:nth-of-type(3)', value: '<a href="/applications/jeudemots/">Jeu de Mots</a> integra este modo audio directamente en las flashcards de frances, ingles y espanol.' }
      ]
    }
  },
  '/blog/prononciation-micro-ia-enfant/': {
    en: {
      title: "AI-scored mic pronunciation | Helping children speak",
      description: "How the microphone and AI analysis help a child correct their pronunciation in a foreign language, with a percentage score and instant feedback.",
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: "Mic pronunciation (AI)" },
        { selector: '.page-hero .page-kicker', value: "Education" },
        { selector: '.page-hero .page-title', value: "AI-scored microphone pronunciation" },
        { selector: '.page-hero .page-subtitle', value: "A percentage score, an encouragement message and a more accurate AI for subscribers: how voice evaluation accelerates children\u2019s progress." },
        { selector: '.content-prose > p:nth-of-type(1)', value: "Learning a language involves speaking. Without feedback, a child sometimes repeats a mistake without knowing. The microphone combined with an AI voice-recognition engine gives immediate and objective feedback." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "What mic evaluation brings" },
        { selector: '.content-prose ul > li:nth-child(1)', value: "A percentage score removes parental subjectivity." },
        { selector: '.content-prose ul > li:nth-child(2)', value: "The heard word is displayed to compare with the correct form." },
        { selector: '.content-prose ul > li:nth-child(3)', value: "Excellent, Good, Almost and Try again messages encourage without judging." },
        { selector: '.content-prose ul > li:nth-child(4)', value: "Premium AI analysis recognises children\u2019s voices and accents better." },
        { selector: '.content-prose h2:nth-of-type(2)', value: "How to add the mic to a session" },
        { selector: '.content-prose ol > li:nth-child(1)', value: "First listen to the word in normal audio mode." },
        { selector: '.content-prose ol > li:nth-child(2)', value: "Listen again in slow mode to catch each syllable." },
        { selector: '.content-prose ol > li:nth-child(3)', value: "Click the mic button and say the word." },
        { selector: '.content-prose ol > li:nth-child(4)', value: "Read the heard word on screen and compare it with the card." },
        { selector: '.content-prose ol > li:nth-child(5)', value: "Try 2 or 3 times: the score rises when pronunciation improves." },
        { selector: '.content-prose > p:nth-of-type(2)', value: "The key is to turn the child into an active participant: they don\u2019t just read words, they produce sound and see numerical progress." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) h3', value: "Related app" },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) p', value: "Jeu de Mots offers the mic and premium AI analysis on all language flashcards." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) .button-row a', value: "See Jeu de Mots" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) h3', value: "Read next" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(1)', value: "Learning a language with audio" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(2)', value: "Flashcards for children: simple method" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(3)', value: "Improve a child\u2019s vocabulary" },
        { selector: '.section-header .section-title', value: "Frequently asked questions" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "Does the mic work offline?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "No. Voice recognition and AI analysis require an active internet connection." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "Is the premium AI analysis really more accurate?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "Yes. The premium AI recognises children\u2019s voices and accents better than the browser\u2019s native recognition, producing a fairer score." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Can the child practice alone?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "Yes. Feedback is immediate and encouraging; the child doesn\u2019t need a parent who speaks the target language." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. All rights reserved.' }
      ],
      html: [
        { selector: '.content-prose > p:nth-of-type(3)', value: '<a href="/applications/jeudemots/">Jeu de Mots</a> offers this voice evaluation on French, English and Spanish flashcards, with premium AI analysis included in the subscription.' }
      ]
    },
    es: {
      title: "Pronunciacion con micro evaluada por IA | Ayudar al nino a hablar",
      description: "Como el microfono y el analisis por IA ayudan al nino a corregir su pronunciacion en un idioma extranjero, con puntuacion en porcentaje y feedback inmediato.",
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: "Pronunciacion con micro (IA)" },
        { selector: '.page-hero .page-kicker', value: "Educacion" },
        { selector: '.page-hero .page-title', value: "Pronunciacion con microfono evaluada por IA" },
        { selector: '.page-hero .page-subtitle', value: "Una puntuacion en porcentaje, un mensaje de animo y una IA mas precisa para los suscriptores: como la evaluacion vocal acelera el progreso del nino." },
        { selector: '.content-prose > p:nth-of-type(1)', value: "Aprender un idioma pasa por la produccion oral. Sin feedback, el nino a veces repite un error sin darse cuenta. El microfono combinado con una IA de reconocimiento de voz da un retorno inmediato y objetivo." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "Lo que aporta la evaluacion por micro" },
        { selector: '.content-prose ul > li:nth-child(1)', value: "Una puntuacion en porcentaje quita la subjetividad del padre." },
        { selector: '.content-prose ul > li:nth-child(2)', value: "La palabra escuchada se muestra para comparar con la forma correcta." },
        { selector: '.content-prose ul > li:nth-child(3)', value: "Los mensajes Excelente, Bien, Casi e Intentalo de nuevo animan sin juzgar." },
        { selector: '.content-prose ul > li:nth-child(4)', value: "El analisis premium por IA reconoce mejor las voces de ninos y los acentos." },
        { selector: '.content-prose h2:nth-of-type(2)', value: "Como integrar el micro en una sesion" },
        { selector: '.content-prose ol > li:nth-child(1)', value: "Escucha primero la palabra en modo audio normal." },
        { selector: '.content-prose ol > li:nth-child(2)', value: "Escucha en modo lento para captar cada silaba." },
        { selector: '.content-prose ol > li:nth-child(3)', value: "Pulsa el boton de microfono y pronuncia la palabra." },
        { selector: '.content-prose ol > li:nth-child(4)', value: "Lee la palabra escuchada mostrada y compara con la carta." },
        { selector: '.content-prose ol > li:nth-child(5)', value: "Repite 2 o 3 veces: la puntuacion sube cuando la pronunciacion mejora." },
        { selector: '.content-prose > p:nth-of-type(2)', value: "La clave es convertir al nino en protagonista: no solo lee palabras, produce sonido y ve su progreso en cifras." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) h3', value: "Aplicacion relacionada" },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) p', value: "Jeu de Mots ofrece el micro y el analisis premium por IA en todas las flashcards de idioma." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) .button-row a', value: "Ver Jeu de Mots" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) h3', value: "Leer a continuacion" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(1)', value: "Aprender un idioma con audio" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(2)', value: "Flashcards para ninos: metodo simple" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(3)', value: "Mejorar el vocabulario de un nino" },
        { selector: '.section-header .section-title', value: "Preguntas frecuentes" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "El microfono funciona sin internet?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "No. El reconocimiento de voz y el analisis por IA requieren una conexion a internet activa." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "Es realmente mas preciso el analisis premium por IA?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "Si. La IA premium reconoce mejor las voces de ninos y los acentos que el reconocimiento nativo del navegador, dando una puntuacion mas justa." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Puede el nino practicar solo?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "Si. El feedback es inmediato y amable; el nino no necesita que un padre hable el idioma objetivo." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. Todos los derechos reservados.' }
      ],
      html: [
        { selector: '.content-prose > p:nth-of-type(3)', value: '<a href="/applications/jeudemots/">Jeu de Mots</a> ofrece esta evaluacion vocal en las flashcards de frances, ingles y espanol, con el analisis premium por IA incluido en la suscripcion.' }
      ]
    }
  },
