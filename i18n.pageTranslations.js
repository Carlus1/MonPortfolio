// Page-level translations extracted from i18n.js
window.__CARLUSONE_PAGE_TRANSLATIONS = {
  '/applications/': {
    en: {
  ...
  '/applications/gesttaches/': {
    en: {
      ...
      text: [
        ...
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'GestTaches is designed for organizations that need clear work distribution: clinics, admin teams, associations, small businesses and any service with a shared schedule.' },
        ...
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(3)', value: 'Required qualifications per task' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: 'Interactive calendar' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Automatic proposals' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(6)', value: 'Reports and statistics' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Pricing' },
        ...
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Track team unavailability.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Publish a validated schedule to all members.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) h2', value: 'Useful links' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(1)', value: 'Open GestTaches' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(2)', value: 'Read article on task management' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(3)', value: 'Read article on team work organisation' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(4)', value: 'Read local Quebec article' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(5)', value: 'See also GestReserve' },
        ...
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-answer', value: 'Yes. GestTaches is well suited to small teams that want to plan tasks and clarify responsibilities.' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-question span', value: 'Can I plan recurring tasks?' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-answer', value: 'Yes. The app lets you manage recurring tasks and organise them in a shared calendar.' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-question span', value: 'Do I need technical training?' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-answer', value: 'No. The interface is designed for quick onboarding without heavy training.' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-question span', value: 'How do I install GestTaches as an app on my phone?' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-answer', value: 'Open GestTaches in your mobile browser, then use Add to Home Screen. On Android: browser menu then Install app or Add to Home screen. On iPhone: Share button then On home screen.' },
        { selector: '.cta-panel h2', value: 'Try GestTaches' },
        { selector: '.cta-panel p', value: 'If you are looking for software to plan a team\u2019s work without spreadsheets or scattered exchanges, GestTaches is the most suitable tool in the suite.' },
      ...
      html: [
        { selector: '.section-soft .content-card ol > li:nth-child(1)', value: '<strong>Create your groups</strong> and add your members with their roles.' },
        { selector: '.section-soft .content-card ol > li:nth-child(2)', value: '<strong>Define your tasks</strong>, recurring or one-off, then assign them.' },
        { selector: '.section-soft .content-card ol > li:nth-child(3)', value: '<strong>Collect team unavailability</strong> in the calendar.' },
        { selector: '.section-soft .content-card ol > li:nth-child(4)', value: '<strong>Run the automatic proposal</strong> to obtain a balanced distribution that respects availability and priorities.' },
        { selector: '.section-soft .content-card ol > li:nth-child(5)', value: '<strong>Validate and publish</strong> the final schedule to all members.' }
      ]
    },
    es: {
      ...
      text: [
        ...
        { selector: '.page-hero .page-subtitle', value: 'GestTaches ayuda a los equipos a planificar el trabajo, repartir tareas, centralizar las indisponibilidades y publicar calendarios mas equilibrados.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) h2', value: 'Descripcion' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'GestTaches esta pensada para organizaciones que necesitan una reparticion clara del trabajo: clinicas, equipos administrativos, asociaciones, pequenas empresas y cualquier servicio con un calendario compartido.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'La aplicacion permite crear grupos, definir tareas puntuales o recurrentes, gestionar roles y proponer asignaciones coherentes segun las disponibilidades.' },
        ...
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(3)', value: 'Cualificaciones requeridas por tarea' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: 'Calendario interactivo' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Propuestas automaticas' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(6)', value: 'Informes y estadisticas' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Precios' },
        ...
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Hacer seguimiento de las indisponibilidades del equipo.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Publicar un calendario validado a todos los miembros.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) h2', value: 'Enlaces utiles' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(1)', value: 'Abrir GestTaches' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(2)', value: 'Leer el articulo sobre gestion de tareas' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(3)', value: 'Leer el articulo sobre organizacion del trabajo en equipo' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(4)', value: 'Leer el articulo local Quebec' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(5)', value: 'Ver tambien GestReserve' },
        ...
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-answer', value: 'Si. GestTaches esta adaptada a equipos pequenos que quieren planificar tareas y clarificar responsabilidades.' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-question span', value: 'Se pueden planificar tareas recurrentes?' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-answer', value: 'Si. La aplicacion permite gestionar tareas recurrentes y organizarlas en un calendario compartido.' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-question span', value: 'Hace falta formacion tecnica?' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-answer', value: 'No. La interfaz esta disenada para un manejo rapido sin formacion pesada.' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-question span', value: 'Como instalo GestTaches como aplicacion en mi movil?' },
        { selector: '.faq-grid .faq-item:nth-child(4) .faq-answer', value: 'Abre GestTaches en tu navegador movil y usa Anadir a la pantalla de inicio. En Android: menu del navegador y Instalar aplicacion o Anadir a pantalla de inicio. En iPhone: boton Compartir y En la pantalla de inicio.' },
        { selector: '.cta-panel h2', value: 'Probar GestTaches' },
        { selector: '.cta-panel p', value: 'Si buscas un software para planificar el trabajo de un equipo sin hojas de calculo ni intercambios dispersos, GestTaches es la herramienta mas adecuada de la suite.' },
      ...
      html: [
        { selector: '.section-soft .content-card ol > li:nth-child(1)', value: '<strong>Crea tus grupos</strong> y anade a tus miembros con sus roles.' },
        { selector: '.section-soft .content-card ol > li:nth-child(2)', value: '<strong>Define tus tareas</strong> puntuales o recurrentes y luego asignalas.' },
        { selector: '.section-soft .content-card ol > li:nth-child(3)', value: '<strong>Recoge las indisponibilidades</strong> del equipo en el calendario.' },
        { selector: '.section-soft .content-card ol > li:nth-child(4)', value: '<strong>Lanza la propuesta automatica</strong> para obtener una reparticion equilibrada que respete las disponibilidades y las prioridades.' },
        { selector: '.section-soft .content-card ol > li:nth-child(5)', value: '<strong>Valida y publica</strong> el calendario final para todos los miembros.' }
      ]
    }
  },
  '/applications/gestbudget/': {
    en: {
      ...
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: 'GestBudget' },
        ...
        { selector: '.content-grid.three-col .content-card:nth-child(1) h2', value: 'Description' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'GestBudget centralises everyday financial movements in a simple interface. The goal is to quickly understand where the money goes and how to better steer your accounts.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'The app suits people who want clear manual tracking without getting lost in a complex tool.' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) h2', value: 'Features' },
        ...
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: 'Income and expense tracking' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Multilingual interface' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Pricing' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ month' },
        ...
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Structure several accounts and payment methods.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Analyse recurring expense categories.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) h2', value: 'Useful links' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(1)', value: 'Open GestBudget' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(2)', value: 'See apps with free trial' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(3)', value: 'Read article on family budget' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(4)', value: 'Read article on budget in Canada' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(5)', value: 'See also GestReserve' },
        { selector: '.section-header .section-title', value: 'Frequently asked questions about GestBudget' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-question span', value: 'Is GestBudget suitable for a family budget?' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-answer', value: 'Yes. GestBudget lets you track income, expenses and categories with a simple view.' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-question span', value: 'Can I manage several accounts?' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-answer', value: 'Yes. The app supports multi-account management to better organise your money flows.' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-question span', value: 'Is there a trial period?' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-answer', value: 'Yes. GestBudget offers a short trial period to test the service.' },
        { selector: '.cta-panel h2', value: 'Discover GestBudget' },
        { selector: '.cta-panel p', value: 'If you are looking for a simple, clear and quick-to-use personal budget app, GestBudget is the most suitable tool in the CarlusOne suite.' },
        { selector: '.cta-panel .button-row a:nth-child(1)', value: 'Open application' },
        { selector: '.cta-panel .button-row a:nth-child(2)', value: 'See all applications' }
      ],
      html: [
        { selector: '.section-soft .content-card ol > li:nth-child(1)', value: '<strong>Create your accounts</strong> (bank, savings, cash, credit card, etc.).' },
        { selector: '.section-soft .content-card ol > li:nth-child(2)', value: '<strong>Add your transactions</strong> by categorising income and expenses.' },
        { selector: '.section-soft .content-card ol > li:nth-child(3)', value: '<strong>Check the dashboard</strong> to track the evolution of your budget.' },
        { selector: '.section-soft .content-card ol > li:nth-child(4)', value: '<strong>Adjust your categories</strong> and accounts to match your personal organisation.' }
      ]
    },
    es: {
      ...
      text: [
        ...
        { selector: '.page-hero .page-subtitle', value: 'GestBudget ayuda a gestionar el presupuesto personal con una vision clara de ingresos, gastos, cuentas y categorias.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) h2', value: 'Descripcion' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'GestBudget centraliza los movimientos financieros del dia a dia en una interfaz simple. El objetivo es entender rapidamente a donde va el dinero y como pilotar mejor las cuentas.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'La aplicacion conviene a quienes desean un seguimiento manual claro sin perderse en una herramienta compleja.' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) h2', value: 'Funciones' },
        ...
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: 'Seguimiento de ingresos y gastos' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Interfaz multilingue' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Precios' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ mes' },
        ...
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Estructurar varias cuentas y medios de pago.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Analizar las categorias de gastos recurrentes.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) h2', value: 'Enlaces utiles' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(1)', value: 'Abrir GestBudget' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(2)', value: 'Ver aplicaciones con prueba gratuita' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(3)', value: 'Leer el articulo sobre presupuesto familiar' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(4)', value: 'Leer el articulo sobre presupuesto en Canada' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(5)', value: 'Ver tambien GestReserve' },
        { selector: '.section-header .section-title', value: 'Preguntas frecuentes sobre GestBudget' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-question span', value: 'GestBudget sirve para un presupuesto familiar?' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-answer', value: 'Si. GestBudget permite seguir ingresos, gastos y categorias con una vista simple.' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-question span', value: 'Se pueden gestionar varias cuentas?' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-answer', value: 'Si. La aplicacion admite la gestion multi-cuentas para organizar mejor tus flujos.' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-question span', value: 'Hay periodo de prueba?' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-answer', value: 'Si. GestBudget ofrece un breve periodo de prueba para probar el servicio.' },
        { selector: '.cta-panel h2', value: 'Descubrir GestBudget' },
        { selector: '.cta-panel p', value: 'Si buscas una aplicacion de presupuesto personal simple, clara y rapida de usar, GestBudget es la herramienta mas adecuada de la suite CarlusOne.' },
        { selector: '.cta-panel .button-row a:nth-child(1)', value: 'Acceder a la aplicacion' },
        { selector: '.cta-panel .button-row a:nth-child(2)', value: 'Ver todas las aplicaciones' }
      ],
      html: [
        { selector: '.section-soft .content-card ol > li:nth-child(1)', value: '<strong>Crea tus cuentas</strong> (banco, ahorro, efectivo, tarjeta de credito, etc.).' },
        { selector: '.section-soft .content-card ol > li:nth-child(2)', value: '<strong>Anade tus transacciones</strong> categorizando ingresos y gastos.' },
        { selector: '.section-soft .content-card ol > li:nth-child(3)', value: '<strong>Consulta el panel</strong> para seguir la evolucion de tu presupuesto.' },
        { selector: '.section-soft .content-card ol > li:nth-child(4)', value: '<strong>Ajusta tus categorias</strong> y cuentas segun tu organizacion personal.' }
      ]
    }
  },
  '/applications/gestreserve/': {
    en: {
      title: 'GestReserve | Simple booking management application',
      description: 'Manage shared resources without scheduling conflicts using GestReserve. 2-day free trial.',
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: 'GestReserve' },
        { selector: '.page-hero .page-kicker', value: 'Resource booking' },
        { selector: '.page-hero .page-title', value: 'Simple booking management application' },
        { selector: '.page-hero .page-subtitle', value: 'GestReserve helps manage the booking of rooms, equipment, vehicles or other shared resources with a clear calendar and per-group access rights.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) h2', value: 'Description' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'GestReserve is designed for organisations that need to share resources without scheduling conflicts. Administrators define the assets, access rules and unavailability. Users then book in just a few clicks.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'The app combines ease of use with access control, making it suitable for small teams as well as multi-user structures.' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) h2', value: 'Features' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(1)', value: 'Interactive booking calendar' },
        ...
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: 'User and role management' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Subscription with free trial' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Pricing' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ month' },
        { selector: '.content-grid.three-col .content-card#tarif .pricing-trial span', value: '2-day free trial' },
        { selector: '.content-grid.three-col .content-card#tarif a.btn', value: 'Get started' },
        ...
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Plan vehicles or common resources.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Book assets visible only to certain groups.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) h2', value: 'Useful links' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(1)', value: 'Open GestReserve' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(2)', value: 'Read work organisation guide' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(3)', value: 'Read article on simple booking' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(4)', value: 'Read article on Quebec booking' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(5)', value: 'See also GestTaches' },
        { selector: '.section-header .section-title', value: 'Frequently asked questions about GestReserve' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-question span', value: 'Does GestReserve let me restrict access by group?' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-answer', value: 'Yes. GestReserve provides group and rights management to control asset visibility.' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-question span', value: 'Can I avoid double bookings?' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-answer', value: 'Yes. The interactive calendar and unavailability rules strongly reduce scheduling conflicts.' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-question span', value: 'Is GestReserve suitable for a small structure?' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-answer', value: 'Yes. The app suits small teams as well as multi-user organisations.' },
        { selector: '.cta-panel h2', value: 'Try GestReserve' },
        { selector: '.cta-panel p', value: 'If your main need is to avoid booking conflicts and better share resources, GestReserve is the most important page in your visit.' },
        { selector: '.cta-panel .button-row a:nth-child(1)', value: 'Open application' },
        { selector: '.cta-panel .button-row a:nth-child(2)', value: 'See all applications' }
      ],
      html: [
        { selector: '.section-soft .content-card ol > li:nth-child(1)', value: '<strong>Create your assets</strong> (rooms, equipment, vehicles) with their booking unit.' },
        { selector: '.section-soft .content-card ol > li:nth-child(2)', value: '<strong>Organise your groups</strong> and assign users to control visibility.' },
        { selector: '.section-soft .content-card ol > li:nth-child(3)', value: '<strong>Book quickly</strong> via the calendar or the list view.' },
        { selector: '.section-soft .content-card ol > li:nth-child(4)', value: '<strong>Manage unavailability</strong> to block certain periods.' }
      ]
    },
    es: {
      title: 'GestReserve | Aplicacion simple de gestion de reservas',
      description: 'Gestione recursos compartidos sin conflictos de planning con GestReserve. 2 dias de prueba gratis.',
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: 'GestReserve' },
        ...
        { selector: '.page-hero .page-subtitle', value: 'GestReserve permite gestionar la reserva de salas, equipos, vehiculos u otros recursos compartidos con un calendario claro y derechos de acceso por grupos.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) h2', value: 'Descripcion' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'GestReserve esta disenada para organizaciones que necesitan compartir recursos sin conflictos de planning. Los administradores definen los bienes, las reglas de acceso y las indisponibilidades. Los usuarios reservan luego con unos pocos clics.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'La aplicacion combina simplicidad de uso y control de acceso, lo que la hace adecuada tanto para equipos pequenos como para estructuras multi-usuario.' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) h2', value: 'Funciones' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(1)', value: 'Calendario de reservas interactivo' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(2)', value: 'Gestion de bienes y de indisponibilidades' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(3)', value: 'Grupos de acceso y visibilidad restringida' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: 'Gestion de usuarios y roles' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Suscripcion con prueba gratuita' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Precios' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ mes' },
        { selector: '.content-grid.three-col .content-card#tarif .pricing-trial span', value: '2 dias de prueba gratis' },
        { selector: '.content-grid.three-col .content-card#tarif a.btn', value: 'Comenzar' },
        ...
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Planificar vehiculos o recursos comunes.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Reservar bienes visibles solo para ciertos grupos.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) h2', value: 'Enlaces utiles' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(1)', value: 'Abrir GestReserve' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(2)', value: 'Leer la guia de organizacion del trabajo' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(3)', value: 'Leer el articulo sobre reserva simple' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(4)', value: 'Leer el articulo sobre reservas Quebec' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(5)', value: 'Ver tambien GestTaches' },
        { selector: '.section-header .section-title', value: 'Preguntas frecuentes sobre GestReserve' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-question span', value: 'GestReserve permite limitar los accesos por grupo?' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-answer', value: 'Si. GestReserve ofrece gestion de grupos y derechos para controlar la visibilidad de los bienes.' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-question span', value: 'Se pueden evitar las dobles reservas?' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-answer', value: 'Si. El calendario interactivo y las reglas de indisponibilidad reducen fuertemente los conflictos de planning.' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-question span', value: 'GestReserve sirve para una estructura pequena?' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-answer', value: 'Si. La aplicacion se adapta a equipos pequenos como a organizaciones multi-usuario.' },
        { selector: '.cta-panel h2', value: 'Probar GestReserve' },
        { selector: '.cta-panel p', value: 'Si tu necesidad principal es evitar los conflictos de reserva y compartir mejor los recursos, GestReserve es la pagina mas importante de tu visita.' },
        { selector: '.cta-panel .button-row a:nth-child(1)', value: 'Acceder a la aplicacion' },
        { selector: '.cta-panel .button-row a:nth-child(2)', value: 'Ver todas las aplicaciones' }
      ],
      html: [
        { selector: '.section-soft .content-card ol > li:nth-child(1)', value: '<strong>Crea tus bienes</strong> (salas, equipos, vehiculos) con su unidad de reserva.' },
        { selector: '.section-soft .content-card ol > li:nth-child(2)', value: '<strong>Organiza tus grupos</strong> y asigna los usuarios para controlar la visibilidad.' },
        { selector: '.section-soft .content-card ol > li:nth-child(3)', value: '<strong>Reserva rapidamente</strong> via el calendario o la vista en lista.' },
        { selector: '.section-soft .content-card ol > li:nth-child(4)', value: '<strong>Gestiona las indisponibilidades</strong> para bloquear ciertos periodos.' }
      ]
    }
  },
  '/applications/transcriptia/': {
    en: {
      title: 'TranscriptIA | AI-assisted audio transcription application',
      description: 'Transcribe your audios locally with TranscriptIA: GPU worker, AI summaries, end-to-end encryption and one-click sharing. Free trial.',
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: 'TranscriptIA' },
        { selector: '.page-hero .page-kicker', value: 'AI Transcription' },
        { selector: '.page-hero .page-title', value: 'AI-assisted audio transcription application' },
        { selector: '.page-hero .page-subtitle', value: 'TranscriptIA turns your audios into structured transcriptions and summaries thanks to a local GPU worker, with end-to-end encryption and one-click sharing to your favourite applications.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) h2', value: 'Description' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'TranscriptIA targets professionals who need to quickly transcribe interviews, meetings or voice notes without sending data to a third-party service. Transcription runs on a local GPU worker based on faster-whisper, then Ollama produces a structured summary.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'All transcriptions are encrypted in the browser before storage, which guarantees content privacy, even from the service administrator.' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) h2', value: 'Features' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(1)', value: 'Upload or record directly from the browser' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(2)', value: 'Local transcription via GPU worker (faster-whisper)' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(3)', value: 'Summary, key points, rephrasing and translation by AI' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: 'End-to-end encryption of transcriptions' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Share / copy / download to other applications' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(6)', value: 'Folder organisation and real-time search' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(7)', value: 'Automatic audio purge after validation' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Pricing' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ month' },
        { selector: '.content-grid.three-col .content-card#tarif .pricing-trial span', value: '7-day free trial' },
        { selector: '.content-grid.three-col .content-card#tarif a.btn', value: 'Get started' },
        { selector: '.section-soft .container:not(.content-grid) > .content-card > h2', value: 'How does it work?' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) h2', value: 'Use cases' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(1)', value: 'Transcribe clinical or research interviews.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(2)', value: 'Keep a structured record of meetings or committees.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Convert voice notes into written reports.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Automatically translate audio content into another language.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(5)', value: 'Archive transcriptions without keeping the source audio file.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) h2', value: 'Useful links' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(1)', value: 'Open TranscriptIA' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(2)', value: 'See all applications' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(3)', value: 'See also GestTaches' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(4)', value: 'Read productivity tools guide' },
        { selector: '.section-header .section-title', value: 'Frequently asked questions about TranscriptIA' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-question span', value: 'Are my audios and transcriptions confidential?' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-answer', value: 'Yes. Transcriptions are encrypted in your browser with a key derived from your password. The server cannot read your content.' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-question span', value: 'How long are my audio files kept?' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-answer', value: 'Unvalidated audios are automatically purged after 72 hours by default. Once the transcription is validated, the audio is deleted immediately and only the report is kept.' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-question span', value: 'Can I send a transcription to another application?' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-answer', value: 'Yes. Each transcription and AI output has Copy, Download and Share buttons that open your device\u2019s native sharing sheet (Mail, WhatsApp, Drive, Notes\u2026).' },
        { selector: '.cta-panel h2', value: 'Try TranscriptIA' },
        { selector: '.cta-panel p', value: 'If you want to turn your audios into structured reports without compromising on confidentiality, TranscriptIA is the tool you need.' },
        { selector: '.cta-panel .button-row a:nth-child(1)', value: 'Open application' },
        { selector: '.cta-panel .button-row a:nth-child(2)', value: 'See all applications' }
      ],
      html: [
        { selector: '.section-soft .content-card ol > li:nth-child(1)', value: '<strong>Upload or record</strong> an audio from your browser (mp3, wav, m4a, webm\u2026).' },
        { selector: '.section-soft .content-card ol > li:nth-child(2)', value: '<strong>The GPU worker transcribes</strong> your file locally with faster-whisper.' },
        { selector: '.section-soft .content-card ol > li:nth-child(3)', value: '<strong>The AI generates a structured report</strong>, key points and, if requested, a translation.' },
        { selector: '.section-soft .content-card ol > li:nth-child(4)', value: '<strong>Review and validate</strong> the result \u2014 the source audio is then purged.' },
        { selector: '.section-soft .content-card ol > li:nth-child(5)', value: '<strong>Share</strong> the content to Mail, WhatsApp, Drive, Notes or any other app via the native sheet.' }
      ]
    },
    es: {
      title: 'TranscriptIA | Aplicacion de transcripcion de audio asistida por IA',
      description: 'Transcriba sus audios localmente con TranscriptIA: worker GPU, resumenes IA, cifrado de extremo a extremo y compartir en un clic. Prueba gratis.',
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: 'TranscriptIA' },
        { selector: '.page-hero .page-kicker', value: 'Transcripcion IA' },
        { selector: '.page-hero .page-title', value: 'Aplicacion de transcripcion de audio asistida por IA' },
        { selector: '.page-hero .page-subtitle', value: 'TranscriptIA transforma sus audios en transcripciones y resumenes estructurados gracias a un worker GPU local, con cifrado de extremo a extremo y compartir en un clic hacia sus aplicaciones favoritas.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) h2', value: 'Descripcion' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'TranscriptIA esta dirigida a profesionales que necesitan transcribir rapidamente entrevistas, reuniones o notas de voz sin enviar sus datos a un servicio externo. La transcripcion la realiza un worker GPU local basado en faster-whisper, y luego Ollama produce un resumen estructurado.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'Todas las transcripciones se cifran en el navegador antes de almacenarse, lo que garantiza la confidencialidad del contenido, incluso frente al administrador del servicio.' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) h2', value: 'Funciones' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(1)', value: 'Subir o grabar directamente desde el navegador' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(2)', value: 'Transcripcion local mediante worker GPU (faster-whisper)' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(3)', value: 'Resumen, puntos clave, reformulacion y traduccion por IA' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: 'Cifrado de extremo a extremo de las transcripciones' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Compartir / copiar / descargar a otras aplicaciones' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(6)', value: 'Organizacion por carpetas y busqueda en tiempo real' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(7)', value: 'Purga automatica de los audios tras validacion' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Precios' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ mes' },
        { selector: '.content-grid.three-col .content-card#tarif .pricing-trial span', value: '7 dias de prueba gratis' },
        { selector: '.content-grid.three-col .content-card#tarif a.btn', value: 'Comenzar' },
        { selector: '.section-soft .container:not(.content-grid) > .content-card > h2', value: 'Como funciona?' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) h2', value: 'Casos de uso' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(1)', value: 'Transcribir entrevistas clinicas o de investigacion.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(2)', value: 'Mantener un registro estructurado de reuniones o comites.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Convertir notas de voz en informes escritos.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Traducir automaticamente un contenido de audio a otro idioma.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(5)', value: 'Archivar transcripciones sin conservar el archivo de audio original.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) h2', value: 'Enlaces utiles' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(1)', value: 'Abrir TranscriptIA' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(2)', value: 'Ver todas las aplicaciones' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(3)', value: 'Ver tambien GestTaches' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(4)', value: 'Leer la guia de herramientas de productividad' },
        { selector: '.section-header .section-title', value: 'Preguntas frecuentes sobre TranscriptIA' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-question span', value: 'Mis audios y transcripciones son confidenciales?' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-answer', value: 'Si. Las transcripciones se cifran en su navegador con una clave derivada de su contrasena. El servidor no puede leer su contenido.' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-question span', value: 'Cuanto tiempo se conservan mis archivos de audio?' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-answer', value: 'Los audios no validados se purgan automaticamente despues de 72 horas por defecto. Una vez validada la transcripcion, el audio se elimina inmediatamente y solo se conserva el informe.' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-question span', value: 'Puedo enviar una transcripcion a otra aplicacion?' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-answer', value: 'Si. Cada transcripcion y cada salida de IA dispone de botones Copiar, Descargar y Compartir que abren el selector nativo de su dispositivo (Mail, WhatsApp, Drive, Notas\u2026).' },
        { selector: '.cta-panel h2', value: 'Probar TranscriptIA' },
        { selector: '.cta-panel p', value: 'Si quiere transformar sus audios en informes estructurados sin comprometer la confidencialidad, TranscriptIA es la herramienta que necesita.' },
        { selector: '.cta-panel .button-row a:nth-child(1)', value: 'Acceder a la aplicacion' },
        { selector: '.cta-panel .button-row a:nth-child(2)', value: 'Ver todas las aplicaciones' }
      ],
      html: [
        { selector: '.section-soft .content-card ol > li:nth-child(1)', value: '<strong>Suba o grabe</strong> un audio desde su navegador (mp3, wav, m4a, webm\u2026).' },
        { selector: '.section-soft .content-card ol > li:nth-child(2)', value: '<strong>El worker GPU transcribe</strong> su archivo localmente con faster-whisper.' },
        { selector: '.section-soft .content-card ol > li:nth-child(3)', value: '<strong>La IA genera un informe estructurado</strong>, puntos clave y, si se solicita, una traduccion.' },
        { selector: '.section-soft .content-card ol > li:nth-child(4)', value: '<strong>Revise y valide</strong> el resultado \u2014 el audio original se purga entonces.' },
        { selector: '.section-soft .content-card ol > li:nth-child(5)', value: '<strong>Comparta</strong> el contenido a Mail, WhatsApp, Drive, Notas o cualquier otra app mediante el selector nativo.' }
      ]
    }
  },
  '/applications/jeudemots/': {
    en: {
      ...
      description: 'Help children progress with flashcards, math quizzes and vocabulary activities. Free trial available.',
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: 'Jeu de Mots' },
        { selector: '.page-hero .page-kicker', value: 'Education' },
        { selector: '.page-hero .page-title', value: 'Simple educational application' },
        { selector: '.page-hero .page-subtitle', value: 'Jeu de Mots helps children, parents and teachers learn through interactive activities, vocabulary words and adapted quizzes.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) h2', value: 'Description' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'Jeu de Mots is designed to make learning smoother and more playful. Users create or import word lists, revise with flashcards and round out the experience with math activities.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'The service suits both home use and the classroom context.' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) h2', value: 'Features' },
        ...
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: 'Student management' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Word lists saved in the cloud' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Pricing' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ month' },
        { selector: '.content-grid.three-col .content-card#tarif .pricing-trial span', value: '2-day free trial' },
        { selector: '.content-grid.three-col .content-card#tarif a.btn', value: 'Get started' },
        ...
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(2)', value: 'Phase 2: subtractions once the concept has been seen in class.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Phase 3: multiplications and then divisions, in that order.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Final phase: mixed worksheets to train both speed and accuracy.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(5)', value: 'Outcome: students who are more confident and stronger in basic arithmetic.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) h2', value: 'Useful links' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(1)', value: 'Open Jeu de Mots' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(2)', value: 'Read the teacher method in detail' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(3)', value: 'Read article on improving children\u2019s vocabulary' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(4)', value: 'Read article on French educational app' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(5)', value: 'See all applications' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(6)', value: 'Discover the CarlusOne suite' },
        { selector: '.section-header .section-title', value: 'Frequently asked questions about Jeu de Mots' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-question span', value: 'Is Jeu de Mots suitable for primary-school children?' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-answer', value: 'Yes. The application is suited to children with short, progressive activities.' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-question span', value: 'Can I work on both vocabulary and arithmetic?' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-answer', value: 'Yes. Jeu de Mots combines vocabulary exercises and math quizzes.' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-question span', value: 'Is the tool useful for teachers?' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-answer', value: 'Yes. Teachers can use it to complement classroom activities and follow progress.' },
        { selector: '.cta-panel h2', value: 'Discover Jeu de Mots' },
        { selector: '.cta-panel p', value: 'For a light, simple and visual learning tool, Jeu de Mots offers a clear solution to families and educators.' },
        { selector: '.cta-panel .button-row a:nth-child(1)', value: 'Open application' },
        { selector: '.cta-panel .button-row a:nth-child(2)', value: 'See all applications' }
      ],
      html: [
    ...
    es: {
      ...
      description: 'Ayude a los ninos a progresar con flashcards, quizzes de matematicas y actividades de vocabulario. Prueba gratuita disponible.',
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: 'Jeu de Mots' },
        { selector: '.page-hero .page-kicker', value: 'Educacion' },
        { selector: '.page-hero .page-title', value: 'Aplicacion educativa simple' },
        { selector: '.page-hero .page-subtitle', value: 'Jeu de Mots ayuda a ninos, padres y docentes a aprender con actividades interactivas, palabras de vocabulario y quizzes adaptados.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) h2', value: 'Descripcion' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(1)', value: 'Jeu de Mots esta disenado para hacer el aprendizaje mas fluido y divertido. Los usuarios crean o importan listas de palabras, repasan con flashcards y completan la experiencia con actividades matematicas.' },
        { selector: '.content-grid.three-col .content-card:nth-child(1) p:nth-of-type(2)', value: 'El servicio conviene tanto en casa como en el contexto escolar.' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) h2', value: 'Funciones' },
        ...
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(4)', value: 'Gestion de estudiantes' },
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(5)', value: 'Listas guardadas en la nube' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Precios' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ mes' },
        { selector: '.content-grid.three-col .content-card#tarif .pricing-trial span', value: '2 dias de prueba gratis' },
        { selector: '.content-grid.three-col .content-card#tarif a.btn', value: 'Comenzar' },
        ...
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(2)', value: 'Fase 2: restas una vez que la nocion se haya visto en clase.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(3)', value: 'Fase 3: multiplicaciones y luego divisiones, en ese orden.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(4)', value: 'Fase final: hojas mixtas para entrenar rapidez y precision.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(1) li:nth-child(5)', value: 'Resultado: alumnos mas seguros y solidos en calculo basico.' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) h2', value: 'Enlaces utiles' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(1)', value: 'Abrir Jeu de Mots' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(2)', value: 'Leer el metodo docente en detalle' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(3)', value: 'Leer el articulo sobre vocabulario infantil' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(4)', value: 'Leer el articulo educativo en frances' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(5)', value: 'Ver todas las aplicaciones' },
        { selector: '.section-soft .content-grid.two-col .content-card:nth-child(2) .note-list a:nth-child(6)', value: 'Descubrir la suite CarlusOne' },
        { selector: '.section-header .section-title', value: 'Preguntas frecuentes sobre Jeu de Mots' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-question span', value: 'Jeu de Mots conviene a ninos de primaria?' },
        { selector: '.faq-grid .faq-item:nth-child(1) .faq-answer', value: 'Si. La aplicacion esta adaptada a los ninos con actividades cortas y progresivas.' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-question span', value: 'Se pueden trabajar vocabulario y calculo?' },
        { selector: '.faq-grid .faq-item:nth-child(2) .faq-answer', value: 'Si. Jeu de Mots combina ejercicios de vocabulario y quizzes de matematicas.' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-question span', value: 'Es util la herramienta para los docentes?' },
        { selector: '.faq-grid .faq-item:nth-child(3) .faq-answer', value: 'Si. Los docentes pueden usarla para complementar las actividades de clase y seguir el progreso.' },
        { selector: '.cta-panel h2', value: 'Descubrir Jeu de Mots' },
        { selector: '.cta-panel p', value: 'Para una herramienta de aprendizaje ligera, simple y visual, Jeu de Mots aporta una solucion clara a familias y educadores.' },
        { selector: '.cta-panel .button-row a:nth-child(1)', value: 'Acceder a la aplicacion' },
        { selector: '.cta-panel .button-row a:nth-child(2)', value: 'Ver todas las aplicaciones' }
      ],
      html: [
  ...
  '/blog/activites-educatives-maison/': {
    en: {
      ...
      text: [
        ...
        { selector: '.content-prose > p:nth-of-type(1)', value: "Helping a child learn at home does not require long sessions. A short, repetitive and playful routine is often more effective." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "Recommended 20-minute routine" },
        { selector: '.content-prose ul > li:nth-child(1)', value: "5 minutes of vocabulary review." },
        { selector: '.content-prose ul > li:nth-child(2)', value: "5 minutes of mental math quiz." },
        { selector: '.content-prose ul > li:nth-child(3)', value: "5 minutes of reading aloud." },
        { selector: '.content-prose ul > li:nth-child(4)', value: "5 minutes to review the day\u2019s mistakes." },
        { selector: '.content-prose > p:nth-of-type(2)', value: "The key point is regularity. 20 minutes a day is better than 2 hours once a week." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) h3', value: "Related app" },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) p', value: "Jeu de Mots combines vocabulary, English and maths in a simple experience." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) .button-row a', value: "See Jeu de Mots" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) h3', value: "Read next" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(1)', value: "Improve a child\u2019s vocabulary" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(2)', value: "French educational app for children" },
        { selector: '.section-header .section-title', value: "Frequently asked questions" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "Which educational activities to do at home?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "Alternate flashcards, short math quizzes and brief reading to keep attention and progress every week." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "How much time per day should you work?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "A 15- to 20-minute daily routine is often enough to obtain visible progress without overloading the child." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Which tool to vary the exercises?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "Jeu de Mots lets you combine vocabulary, English and maths in a playful interface." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. All rights reserved.' }
      ],
      html: [
        { selector: '.content-prose > p:nth-of-type(3)', value: 'With <a href="/applications/jeudemots/">Jeu de Mots</a>, you can vary activities quickly and keep visible progress.' }
      ]
    },
    es: {
      ...
      text: [
        ...
        { selector: '.content-prose > p:nth-of-type(1)', value: "Ayudar a un nino a aprender en casa no requiere sesiones largas. Una rutina corta, repetitiva y divertida suele ser mas efectiva." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "Rutina recomendada de 20 minutos" },
        { selector: '.content-prose ul > li:nth-child(1)', value: "5 minutos de repaso de vocabulario." },
        { selector: '.content-prose ul > li:nth-child(2)', value: "5 minutos de quiz de calculo mental." },
        { selector: '.content-prose ul > li:nth-child(3)', value: "5 minutos de lectura en voz alta." },
        { selector: '.content-prose ul > li:nth-child(4)', value: "5 minutos para revisar los errores del dia." },
        { selector: '.content-prose > p:nth-of-type(2)', value: "El punto clave es la regularidad. Mejor 20 minutos al dia que 2 horas una vez por semana." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) h3', value: "Aplicacion relacionada" },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) p', value: "Jeu de Mots combina vocabulario, ingles y matematicas en una experiencia simple." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) .button-row a', value: "Ver Jeu de Mots" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) h3', value: "Leer a continuacion" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(1)', value: "Mejorar el vocabulario de un nino" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(2)', value: "Aplicacion educativa de frances para ninos" },
        { selector: '.section-header .section-title', value: "Preguntas frecuentes" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "Que actividades educativas hacer en casa?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "Alterna flashcards, pequenos quiz de calculo y lectura corta para mantener la atencion y progresar cada semana." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "Cuanto tiempo al dia hay que trabajar?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "Una rutina de 15 a 20 minutos al dia suele bastar para obtener progresos visibles sin sobrecargar al nino." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Que herramienta usar para variar los ejercicios?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "Jeu de Mots permite combinar vocabulario, ingles y matematicas en una interfaz divertida." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. Todos los derechos reservados.' }
      ],
      html: [
        { selector: '.content-prose > p:nth-of-type(3)', value: 'Con <a href="/applications/jeudemots/">Jeu de Mots</a> puedes variar las actividades rapidamente y mantener un progreso visible.' }
      ]
    }
  },
  '/blog/defi-calcul-mental-classe-5-minutes/': {
    en: {
      ...
      text: [
        ...
        { selector: '.content-prose > p:nth-of-type(1)', value: "A short ritual, repeated each day, can lastingly change classroom mastery of mental arithmetic. The idea is simple: print operation sheets, time 5 minutes, then correct quickly to track progress." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "Educational objective" },
        { selector: '.content-prose > p:nth-of-type(2)', value: "Build reliable automatisms in addition, subtraction, multiplication and division, without lengthening class time." },
        ...
        { selector: '.content-prose ul > li:nth-child(1)', value: "Set a fixed 5-minute slot (start or end of class)." },
        { selector: '.content-prose ul > li:nth-child(2)', value: "Hand out the day\u2019s sheet according to the topic in progress." },
        { selector: '.content-prose ul > li:nth-child(3)', value: "Give quick feedback: score, frequent mistakes, areas for progress." },
        { selector: '.content-prose ul > li:nth-child(4)', value: "Keep results to visualise progress over several weeks." },
        { selector: '.content-prose h2:nth-of-type(4)', value: "Final stage: mixed operations" },
        { selector: '.content-prose > p:nth-of-type(3)', value: "Once the 4 operations have been worked on separately, offer mixed sheets. This forces students to quickly identify the calculation strategy and reinforces mental flexibility." },
        { selector: '.content-prose h2:nth-of-type(5)', value: "Expected outcomes" },
        { selector: '.content-prose > p:nth-of-type(4)', value: "Students gain in speed, accuracy and confidence. Within a few weeks, basic arithmetic becomes more fluid, which also makes it easier to solve more complex problems." },
        { selector: '.blog-sidebar .content-card h3', value: "Related resources" },
        { selector: '.blog-sidebar .note-list a:nth-of-type(1)', value: "Jeu de Mots product page" },
        { selector: '.blog-sidebar .note-list a:nth-of-type(2)', value: "Open the application" },
        { selector: '.blog-sidebar .note-list a:nth-of-type(3)', value: "French educational app for children" },
        { selector: '.blog-sidebar .note-list a:nth-of-type(4)', value: "Educational activities at home" },
        { selector: '.section-header .section-title', value: "Frequently asked questions" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "How long does a session last?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "5 minutes is enough for an effective ritual, especially when it is regular." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "Should operations be mixed from the start?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "No. It is preferable to follow the order: addition, subtraction, multiplication, division, then mixed." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Is this method suitable for different levels?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "Yes. You can adapt the numerical range (0-5, then 0-10) and the complexity to the students." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. All rights reserved.' }
      ],
      html: [
        { selector: '.content-prose ol > li:nth-child(1)', value: '<strong>Addition 0 to 5</strong>: consolidate the basics with an accessible level.' },
        { selector: '.content-prose ol > li:nth-child(2)', value: '<strong>Addition 0 to 10</strong>: gradually increase the difficulty.' },
        { selector: '.content-prose ol > li:nth-child(3)', value: '<strong>Subtraction</strong>: introduce simple exercises then scale up.' },
        { selector: '.content-prose ol > li:nth-child(4)', value: '<strong>Multiplication</strong>: work on times tables regularly.' },
        { selector: '.content-prose ol > li:nth-child(5)', value: '<strong>Division</strong>: finalise with operations adapted to the level.' },
        { selector: '.content-prose > p:nth-of-type(5)', value: 'To put this method in place quickly, you can use the printable sheets from <a href="/applications/jeudemots/">Jeu de Mots</a>.' }
      ]
    },
    es: {
      ...
      text: [
        ...
        { selector: '.content-prose > p:nth-of-type(1)', value: "Un ritual corto, repetido cada dia, puede cambiar de forma duradera el dominio del calculo en clase. La idea es simple: imprimir hojas de operaciones, cronometrar 5 minutos y corregir rapido para seguir la progresion." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "Objetivo pedagogico" },
        { selector: '.content-prose > p:nth-of-type(2)', value: "Instalar automatismos fiables en suma, resta, multiplicacion y division, sin alargar el tiempo de clase." },
        ...
        { selector: '.content-prose ul > li:nth-child(1)', value: "Definir una franja fija de 5 minutos (al inicio o al final de la clase)." },
        { selector: '.content-prose ul > li:nth-child(2)', value: "Distribuir la hoja del dia segun el tema en curso." },
        { selector: '.content-prose ul > li:nth-child(3)', value: "Hacer un retorno rapido: puntuacion, errores frecuentes, ejes de progreso." },
        { selector: '.content-prose ul > li:nth-child(4)', value: "Conservar los resultados para visualizar los progresos a lo largo de varias semanas." },
        { selector: '.content-prose h2:nth-of-type(4)', value: "Etapa final: operaciones mezcladas" },
        { selector: '.content-prose > p:nth-of-type(3)', value: "Una vez trabajadas por separado las 4 operaciones, propon hojas mezcladas. Esto obliga a los alumnos a identificar rapidamente la estrategia de calculo y refuerza la flexibilidad mental." },
        { selector: '.content-prose h2:nth-of-type(5)', value: "Resultados esperados" },
        { selector: '.content-prose > p:nth-of-type(4)', value: "Los alumnos ganan en velocidad, precision y confianza. En pocas semanas, el calculo basico se vuelve mas fluido, lo que tambien facilita la resolucion de problemas mas complejos." },
        { selector: '.blog-sidebar .content-card h3', value: "Recursos relacionados" },
        { selector: '.blog-sidebar .note-list a:nth-of-type(1)', value: "Pagina de producto Jeu de Mots" },
        { selector: '.blog-sidebar .note-list a:nth-of-type(2)', value: "Abrir la aplicacion" },
        { selector: '.blog-sidebar .note-list a:nth-of-type(3)', value: "Aplicacion educativa de frances para ninos" },
        { selector: '.blog-sidebar .note-list a:nth-of-type(4)', value: "Actividades educativas en casa" },
        { selector: '.section-header .section-title', value: "Preguntas frecuentes" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "Cuanto dura una sesion?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "5 minutos bastan para un ritual eficaz, sobre todo si es regular." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "Hay que mezclar las operaciones desde el principio?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "No. Es preferible seguir el orden: suma, resta, multiplicacion, division y luego mezcla." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Este metodo se adapta a niveles diferentes?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "Si. Puedes adaptar el rango numerico (0-5, luego 0-10) y la complejidad segun los alumnos." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. Todos los derechos reservados.' }
      ],
      html: [
        { selector: '.content-prose ol > li:nth-child(1)', value: '<strong>Suma 0 a 5</strong>: consolidar las bases con un nivel accesible.' },
        { selector: '.content-prose ol > li:nth-child(2)', value: '<strong>Suma 0 a 10</strong>: aumentar progresivamente la dificultad.' },
        { selector: '.content-prose ol > li:nth-child(3)', value: '<strong>Resta</strong>: introducir ejercicios simples y luego graduar.' },
        { selector: '.content-prose ol > li:nth-child(4)', value: '<strong>Multiplicacion</strong>: trabajar las tablas de manera regular.' },
        { selector: '.content-prose ol > li:nth-child(5)', value: '<strong>Division</strong>: finalizar con operaciones adaptadas al nivel.' },
        { selector: '.content-prose > p:nth-of-type(5)', value: 'Para implementar este metodo rapidamente, puedes usar las hojas imprimibles de <a href="/applications/jeudemots/">Jeu de Mots</a>.' }
      ]
    }
  },
  '/blog/flashcards-enfant-methode-simple/': {
    en: {
      ...
      text: [
        ...
        { selector: '.content-prose > p:nth-of-type(1)', value: "Flashcards are effective when used at a regular pace and with a limited number of cards per session." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "Recommended structure" },
        { selector: '.content-prose ul > li:nth-child(1)', value: "10 to 15 minute session." },
        { selector: '.content-prose ul > li:nth-child(2)', value: "10 to 20 cards maximum." },
        { selector: '.content-prose ul > li:nth-child(3)', value: "Repeat difficult cards at the end of the session." },
        { selector: '.content-prose ul > li:nth-child(4)', value: "A short review the next day." },
        { selector: '.content-prose > p:nth-of-type(2)', value: "Avoid trying to review everything at once. Spaced repetition is the key to lasting memorisation." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) h3', value: "Related app" },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) p', value: "Jeu de Mots makes flashcard work easier with adapted lists." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) .button-row a', value: "See Jeu de Mots" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) h3', value: "Read next" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(1)', value: "Educational activities at home" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(2)', value: "Improve a child\u2019s vocabulary" },
        { selector: '.section-header .section-title', value: "Frequently asked questions" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "How many cards to use per session?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "Between 10 and 20 cards per session is a good volume to keep concentration without fatigue." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "Should you correct each mistake right away?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "Yes, correct quickly then present the same card again later in the session to consolidate memorisation." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Which tool to manage flashcards?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "Jeu de Mots offers a simple flashcard mode with progress per student." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. All rights reserved.' }
      ],
      html: [
        { selector: '.content-prose > p:nth-of-type(3)', value: '<a href="/applications/jeudemots/">Jeu de Mots</a> helps organise this practice with a simple path for each child.' }
      ]
    },
    es: {
      ...
      text: [
        ...
        { selector: '.content-prose > p:nth-of-type(1)', value: "Las flashcards son efectivas cuando se usan a un ritmo regular y con un numero limitado de tarjetas por sesion." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "Estructura recomendada" },
        { selector: '.content-prose ul > li:nth-child(1)', value: "Sesion de 10 a 15 minutos." },
        { selector: '.content-prose ul > li:nth-child(2)', value: "10 a 20 tarjetas maximo." },
        { selector: '.content-prose ul > li:nth-child(3)', value: "Repetir las tarjetas dificiles al final de la sesion." },
        { selector: '.content-prose ul > li:nth-child(4)', value: "Un breve repaso al dia siguiente." },
        { selector: '.content-prose > p:nth-of-type(2)', value: "Evita querer repasar todo de una sola vez. La repeticion espaciada es la clave para memorizar de forma duradera." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) h3', value: "Aplicacion relacionada" },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) p', value: "Jeu de Mots facilita el trabajo con flashcards mediante listas adaptadas." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) .button-row a', value: "Ver Jeu de Mots" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) h3', value: "Leer a continuacion" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(1)', value: "Actividades educativas en casa" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(2)', value: "Mejorar el vocabulario de un nino" },
        { selector: '.section-header .section-title', value: "Preguntas frecuentes" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "Cuantas tarjetas usar por sesion?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "Entre 10 y 20 tarjetas por sesion es un buen volumen para mantener la concentracion sin fatiga." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "Hay que corregir cada error de inmediato?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "Si, corrige rapido y luego vuelve a presentar la misma tarjeta mas tarde en la sesion para consolidar la memorizacion." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Que herramienta usar para gestionar las flashcards?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "Jeu de Mots ofrece un modo flashcards simple con progreso por estudiante." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. Todos los derechos reservados.' }
      ],
      html: [
        { selector: '.content-prose > p:nth-of-type(3)', value: '<a href="/applications/jeudemots/">Jeu de Mots</a> ayuda a organizar esta practica con un recorrido simple para cada nino.' }
      ]
    }
  },
  '/blog/optimiser-planning-reservations/': {
    en: {
      ...
      text: [
        ...
        { selector: '.content-prose > p:nth-of-type(1)', value: "An inefficient reservation schedule quickly creates tension: duplicates, last-minute cancellations and wasted time." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "4-step optimisation plan" },
        { selector: '.content-prose ol > li:nth-child(1)', value: "Centralise all reservations in a single calendar." },
        { selector: '.content-prose ol > li:nth-child(2)', value: "Set minimum and maximum duration rules." },
        { selector: '.content-prose ol > li:nth-child(3)', value: "Block unavailable periods in advance." },
        { selector: '.content-prose ol > li:nth-child(4)', value: "Analyse recurring conflicts every week." },
        { selector: '.content-prose > p:nth-of-type(2)', value: "When these rules are applied, the coordination workload decreases significantly." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) h3', value: "Related app" },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) p', value: "GestReserve centralises reservations and reduces scheduling errors." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) .button-row a', value: "See GestReserve" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) h3', value: "Read next" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(1)', value: "Choose simple reservation software" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(2)', value: "Reservation software in Quebec" },
        { selector: '.section-header .section-title', value: "Frequently asked questions" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "How to avoid double bookings?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "Use a real-time centralised calendar, duration rules and clear visibility of unavailable slots." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "Why segment resources by group?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "Segmentation by group limits access errors and makes coordination between teams easier." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Which tool to choose to manage a reservation schedule?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "GestReserve is well suited to centralise reservations of rooms, equipment or vehicles." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. All rights reserved.' }
      ],
      html: [
        { selector: '.content-prose > p:nth-of-type(3)', value: '<a href="/applications/gestreserve/">GestReserve</a> helps put this framework in place easily with group-based access.' }
      ]
    },
    es: {
      ...
      text: [
        ...
        { selector: '.content-prose > p:nth-of-type(1)', value: "Un calendario de reservas ineficiente genera rapidamente tensiones: duplicados, cancelaciones de ultimo minuto y perdida de tiempo." },
        { selector: '.content-prose h2:nth-of-type(1)', value: "Plan de optimizacion en 4 pasos" },
        { selector: '.content-prose ol > li:nth-child(1)', value: "Centralizar todas las reservas en un solo calendario." },
        { selector: '.content-prose ol > li:nth-child(2)', value: "Definir reglas de duracion minima y maxima." },
        { selector: '.content-prose ol > li:nth-child(3)', value: "Bloquear con antelacion los periodos de no disponibilidad." },
        { selector: '.content-prose ol > li:nth-child(4)', value: "Analizar cada semana los conflictos recurrentes." },
        { selector: '.content-prose > p:nth-of-type(2)', value: "Cuando se aplican estas reglas, la carga de coordinacion disminuye notablemente." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) h3', value: "Aplicacion relacionada" },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) p', value: "GestReserve centraliza las reservas y reduce los errores de planificacion." },
        { selector: '.blog-sidebar .content-card:nth-of-type(1) .button-row a', value: "Ver GestReserve" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) h3', value: "Leer a continuacion" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(1)', value: "Elegir un software de reservas simple" },
        { selector: '.blog-sidebar .content-card:nth-of-type(2) .note-list a:nth-of-type(2)', value: "Software de reservas en Quebec" },
        { selector: '.section-header .section-title', value: "Preguntas frecuentes" },
        { selector: '.faq-item:nth-of-type(1) .faq-question span', value: "Como evitar las dobles reservas?" },
        { selector: '.faq-item:nth-of-type(1) .faq-answer', value: "Usa un calendario centralizado en tiempo real, reglas de duracion y una visibilidad clara de las indisponibilidades." },
        { selector: '.faq-item:nth-of-type(2) .faq-question span', value: "Por que segmentar los recursos por grupo?" },
        { selector: '.faq-item:nth-of-type(2) .faq-answer', value: "La segmentacion por grupo limita los errores de acceso y facilita la coordinacion entre equipos." },
        { selector: '.faq-item:nth-of-type(3) .faq-question span', value: "Que herramienta elegir para gestionar un calendario de reservas?" },
        { selector: '.faq-item:nth-of-type(3) .faq-answer', value: "GestReserve es adecuado para centralizar las reservas de salas, equipos o vehiculos." },
        { selector: '.footer-bottom p', value: '\u00A9 2026 CarlusOne. Todos los derechos reservados.' }
      ],
      html: [
        { selector: '.content-prose > p:nth-of-type(3)', value: '<a href="/applications/gestreserve/">GestReserve</a> ayuda a implementar este marco de forma sencilla con accesos por grupo.' }
      ]
    }
  },
