  ...
  '/applications/jeudemots/': {
    en: {
      ...
      text: [
        ...
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) h3', value: '📊 History and follow-up' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) > p', value: 'Every session is saved in My sessions for the teacher:' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) li:nth-child(1)', value: 'Real-time list of all your past sessions (code, date, duration, status, number of students)' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) li:nth-child(2)', value: 'Per-session detail with the final score of each student' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) li:nth-child(3)', value: 'UTF-8 CSV export compatible with Excel and Google Sheets to enter grades in your gradebook' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) li:nth-child(4)', value: 'Individual deletion with confirmation' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(2) h3', value: 'Why it matters in class' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(2) li:nth-child(1)', value: 'Zero friction for students — a QR code, a first name, done' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(2) li:nth-child(2)', value: 'No photocopies — less prep, less paper' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(2) li:nth-child(3)', value: 'Instant feedback — each student sees their mistakes the second they finish' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(2) li:nth-child(4)', value: 'Consolidated results — no manual grading, everything is calculated' },
    ...
    es: {
      ...
      text: [
        ...
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) h3', value: '📊 Historial y seguimiento' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) > p', value: 'Cada sesion se conserva en Mis sesiones para el docente:' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) li:nth-child(1)', value: 'Lista en tiempo real de todas sus sesiones pasadas (codigo, fecha, duracion, estado, numero de estudiantes)' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) li:nth-child(2)', value: 'Detalle por sesion con la puntuacion final de cada estudiante' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) li:nth-child(3)', value: 'Exportacion CSV UTF-8 compatible con Excel y Google Sheets para llevar las notas al cuaderno' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(1) li:nth-child(4)', value: 'Eliminacion individual con confirmacion' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(2) h3', value: 'Por que cambia todo en clase' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(2) li:nth-child(1)', value: 'Cero friccion para los estudiantes — un QR, un nombre, listo' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(2) li:nth-child(2)', value: 'Sin fotocopias — menos preparacion, menos papel' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(2) li:nth-child(3)', value: 'Retroalimentacion inmediata — cada estudiante ve sus errores en cuanto termina' },
        { selector: '#mode-classe-live .container > .content-card:nth-of-type(2) li:nth-child(4)', value: 'Resultados consolidados — sin correccion manual, todo se calcula' },
