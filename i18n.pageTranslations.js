...
window.__CARLUSONE_PAGE_TRANSLATIONS = {
  ...
  '/applications/jeudemots/': {
    en: {
      ...
      description: 'Help children progress with audio flashcards, AI-scored mic pronunciation, math quizzes and printable worksheets. Free trial available.',
      text: [
        ...
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(7)', value: 'Student management + cloud sync' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Pricing' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ month' },
        { selector: '.content-grid.three-col .content-card#tarif .pricing-trial span', value: '2-day free trial' },
        { selector: '.content-grid.three-col .content-card#tarif a.btn', value: 'Get started' },
        ...
        { selector: '.faq-grid .faq-item:nth-child(6) .faq-question span', value: 'How do I install Jeu de Mots as an app on my phone?' },
        { selector: '.faq-grid .faq-item:nth-child(6) .faq-answer', value: 'Open Jeu de Mots in your mobile browser, then use Add to Home Screen. On Android: browser menu then Install app or Add to Home screen. On iPhone: Share button then On home screen.' },
    ...
    es: {
      ...
      description: 'Ayude a los ninos a progresar con flashcards audio, pronunciacion con microfono evaluada por IA, quizzes de matematicas y hojas imprimibles. Prueba gratuita.',
      text: [
        { selector: '.page-hero .breadcrumb span:last-child', value: 'Jeu de Mots' },
        ...
        { selector: '.content-grid.three-col .content-card:nth-child(2) li:nth-child(7)', value: 'Gestion de estudiantes + nube' },
        { selector: '.content-grid.three-col .content-card#tarif h2', value: 'Precios' },
        { selector: '.content-grid.three-col .content-card#tarif .price-period', value: '/ mes' },
        { selector: '.content-grid.three-col .content-card#tarif .pricing-trial span', value: '2 dias de prueba gratis' },
        { selector: '.content-grid.three-col .content-card#tarif a.btn', value: 'Comenzar' },
        ...
        { selector: '.faq-grid .faq-item:nth-child(6) .faq-question span', value: 'Como instalo Jeu de Mots como aplicacion en mi movil?' },
        { selector: '.faq-grid .faq-item:nth-child(6) .faq-answer', value: 'Abre Jeu de Mots en tu navegador movil y usa Anadir a la pantalla de inicio. En Android: menu del navegador y Instalar aplicacion o Anadir a pantalla de inicio. En iPhone: boton Compartir y En la pantalla de inicio.' },
